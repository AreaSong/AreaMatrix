...
| `global-product-ui-localization` | `closed` | `product-contract-gap` | none | 独立 Language 一级页、两套选择器、General/Repository 摘要跳转、四组合 UI fixture、完整 macOS 门禁与双语言 7-target 概述重生成证据均已闭环。 |
