...
| `global-product-ui-localization` | `open` | `product-contract-gap` | 完整 macOS 治理门禁与显式概述重生成证据尚未闭环 | 独立 Language 一级页、两套选择器、General/Repository 摘要跳转和四组合 fixture UI 已落地；完整关闭证据仍待补齐。 |
