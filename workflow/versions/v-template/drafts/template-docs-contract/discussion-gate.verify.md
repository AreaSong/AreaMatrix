# V-TEMPLATE Verify-ready Draft: template-docs-contract/discussion-gate
...
- Task: `discussion-gate` - Validate discussion decisions and boundary language for the template reference.
- Risk: `Low`

## 必须读取
- Change YAML: `workflow/versions/v-template/changes/template-contracts.yaml`
- Manifest draft section: `## template-docs-contract/discussion-gate`
