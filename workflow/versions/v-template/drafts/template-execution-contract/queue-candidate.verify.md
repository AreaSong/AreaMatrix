# V-TEMPLATE Verify-ready Draft: template-execution-contract/queue-candidate
...
- Task: `queue-candidate` - Validate version-local queue candidate structure for the template reference.
- Risk: `Low`

## 必须读取
- Change YAML: `workflow/versions/v-template/changes/template-contracts.yaml`
- Manifest draft section: `## template-execution-contract/queue-candidate`
