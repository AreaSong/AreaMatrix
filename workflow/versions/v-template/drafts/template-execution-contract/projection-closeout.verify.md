# V-TEMPLATE Verify-ready Draft: template-execution-contract/projection-closeout
...
- Task: `projection-closeout` - Validate projection and closeout evidence gates for the template reference.
- Risk: `Low`

## 必须读取
- Change YAML: `workflow/versions/v-template/changes/template-contracts.yaml`
- Manifest draft section: `## template-execution-contract/projection-closeout`
