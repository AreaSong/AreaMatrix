...
Docs baselines record Exact Docs line ranges and hashes for drift detection.
...
- Durable governance residuals are indexed under `../residuals/`; baseline readiness does not close or execute them.
