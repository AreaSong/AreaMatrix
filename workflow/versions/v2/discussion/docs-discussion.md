...
- Intent: define the next real planning scope only after Stage 1 MVP historical materials are fully closed out.
- User paths: to be confirmed before changes YAML is written.
...
- Exact v2 scope is not approved yet.
