...
| `docs/governance/governance-register.yaml` | 1-1714 | AM-GOV-REGISTER-001 | create | Record owners, per-file document registration, document domains, repo-wide domain ownership, core module and macOS feature correspondence, RAID probability/impact/scope, external dependencies, and capability lifecycle. | `authoring` |
