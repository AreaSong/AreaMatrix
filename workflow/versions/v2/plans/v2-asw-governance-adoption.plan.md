...
| `docs/governance/governance-register.yaml` | 1-483 | AM-GOV-REGISTER-001 | create | Record owners, document metadata, document domains, repo-wide domain ownership, RAID probability/impact/scope, external dependencies, and capability lifecycle. | `authoring` |
