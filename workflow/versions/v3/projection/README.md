# v3 Result Projection

Result Projection are review artifacts for v3; they do not write version execution or historical v1 execution.

- Version-local queue starts at `phase-0 / 0-1 / task-01`.
- Execution root: `workflow/versions/v3/execution/`.
