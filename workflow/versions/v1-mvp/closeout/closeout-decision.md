...
- Start `workflow/versions/v2/` discussion and planning through the normal workflow gate.
- Produce v2 middle-layer, changes, plans, drafts, and queue candidates for review.
