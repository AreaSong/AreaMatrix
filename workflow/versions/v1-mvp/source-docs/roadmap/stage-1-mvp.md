...
详见 [milestones.md#stage-1-mvp](../../../../../docs/roadmap/milestones.md#stage-1mvp约-5-个月) 核心交付。
...
- [ ] 错误类型 `CoreError`（[error-codes.md](../../../../../docs/api/error-codes.md)）
- [ ] DB schema v1 + migration 框架（[data-model.md](../../../../../docs/architecture/data-model.md)）
...
- [ ] `area_matrix.udl` 完整定义（[ffi-design.md](../../../../../docs/architecture/ffi-design.md)）
...
- [ ] 手工冒烟清单 100% 过
- [ ] 崩溃测试至少 50 轮无丢数据
- [ ] 性能基准对照（[testing.md#性能测试](../../../../../docs/development/testing.md)）
...
- [ ] 内测分发说明（如何获取 / 如何反馈）
- [ ] Release 流程演练（[release.md](../../../../../docs/development/release.md)）
- [ ] 签名 + 公证测试
...
每个迭代结束做 retrospective，更新 [milestones.md](../../../../../docs/roadmap/milestones.md)。
