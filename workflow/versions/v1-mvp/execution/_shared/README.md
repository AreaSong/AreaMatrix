...
python3 workflow/versions/v1-mvp/execution/_shared/prompt_pipeline.py render --task 0-2/task-01
python3 workflow/versions/v1-mvp/execution/_shared/prompt_pipeline.py verify --task 0-2/task-01
python3 workflow/versions/v1-mvp/execution/_shared/prompt_pipeline.py verify --phase phase-0
python3 workflow/versions/v1-mvp/execution/_shared/prompt_pipeline.py mark --task 0-2/task-01 --status completed
