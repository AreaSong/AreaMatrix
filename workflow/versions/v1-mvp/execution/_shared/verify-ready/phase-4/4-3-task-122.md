# Verify-ready Prompt: 4-3/task-122
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-122`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-122-s4-win-03-c4-14-onedrive-risk-state.md`
...
- Manifest 章节：`## 4-3/task-122`
- 依赖任务：`4-3/task-121, 4-3/task-70`
- 风险等级：`High`
- 绑定 UX 页面：`S4-WIN-03-onedrive-notice`
- 绑定 Core 能力：`C4-14`
- Control map 期望 Core 能力：`S4-WIN-03: C4-08, C4-14`
- 当前 task 覆盖 Core 能力：`C4-14`
- Secondary capability 状态：`C4-08（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-122-s4-win-03-c4-14-onedrive-risk-state.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-122`
