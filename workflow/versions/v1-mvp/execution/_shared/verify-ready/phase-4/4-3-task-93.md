# Verify-ready Prompt: 4-3/task-93
...
- Phase：`phase-4`
- Task 标识：`4-3/task-93`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-93-c4-19-failure-edge.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-93-c4-19-failure-edge.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-93`
