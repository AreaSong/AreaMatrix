# Verify-ready Prompt: 4-1/task-05
...
- Phase：`phase-4`
- Task 标识：`4-1/task-05`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-05-c2-01-integration-verify.md`
...
- Manifest 章节：`## 4-1/task-05`
- 依赖任务：`4-1/task-04`
- 风险等级：`High`
- 绑定 UX 页面：`S2-01-search-results, S2-04-search-empty, S2-05-query-error`
- 绑定 Core 能力：`C2-01`
- Control map 期望 Core 能力：`S2-01: C2-01, C2-02; S2-04: C2-01; S2-05: C2-01`
- 当前 task 覆盖 Core 能力：`C2-01`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-05-c2-01-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-05`
