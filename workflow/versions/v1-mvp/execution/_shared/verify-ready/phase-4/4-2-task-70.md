# Verify-ready Prompt: 4-2/task-70
...
- 类型：单任务验收
- 任务类型：`integration`
- 任务细分：`page-integration`
- Phase：`phase-4`
- Task 标识：`4-2/task-70`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-70-s3-08-page-integration-verify.md`
...
- Manifest 章节：`## 4-2/task-70`
- 依赖任务：`4-2/task-67, 4-2/task-68, 4-2/task-69`
- 风险等级：`High`
- 绑定 UX 页面：`S3-08-semantic-search-results`
- 绑定 Core 能力：`C3-08, C3-09, C3-10`
- Control map 期望 Core 能力：`S3-08: C3-08, C3-09, C3-10`
- 当前 task 覆盖 Core 能力：`C3-08, C3-09, C3-10`
- Secondary capability 状态：`None`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `6` 个，现有代码 `2` 项，预期新增路径 `2` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-70-s3-08-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-70`
