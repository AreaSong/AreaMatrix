# Verify-ready Prompt: 4-2/task-20
...
- Phase：`phase-4`
- Task 标识：`4-2/task-20`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-20-c3-04-integration-verify.md`
...
- Manifest 章节：`## 4-2/task-20`
- 依赖任务：`4-2/task-19`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S3-04-ai-classification-suggestion, S3-10-ai-fallback`
- 绑定 Core 能力：`C3-04`
- Control map 期望 Core 能力：`S3-04: C3-04, C3-09, C3-10; S3-10: C3-04, C3-08, C3-10`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-20-c3-04-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-20`
