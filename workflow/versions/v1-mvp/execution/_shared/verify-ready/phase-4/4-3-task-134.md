# Verify-ready Prompt: 4-3/task-134
...
- Phase：`phase-4`
- Task 标识：`4-3/task-134`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-134-s4-lnx-03-page-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-134`
- 依赖任务：`4-3/task-132, 4-3/task-133`
- 风险等级：`High`
- 绑定 UX 页面：`S4-LNX-03-local-folder-notice`
- 绑定 Core 能力：`C4-10, C4-17`
- Control map 期望 Core 能力：`S4-LNX-03: C4-10, C4-17`
- 当前 task 覆盖 Core 能力：`C4-10, C4-17`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-134-s4-lnx-03-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-134`
