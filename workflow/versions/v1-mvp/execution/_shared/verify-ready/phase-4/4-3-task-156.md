# Verify-ready Prompt: 4-3/task-156
...
- Phase：`phase-4`
- Task 标识：`4-3/task-156`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-156-s4-x-05-page-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-156`
- 依赖任务：`4-3/task-153, 4-3/task-154, 4-3/task-155`
- 风险等级：`High`
- 绑定 UX 页面：`S4-X-05-repository-adopt-confirm`
- 绑定 Core 能力：`C4-02, C4-09, C4-10`
- Control map 期望 Core 能力：`S4-X-05: C4-02, C4-09, C4-10`
- 当前 task 覆盖 Core 能力：`C4-02, C4-09, C4-10`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-156-s4-x-05-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-156`
