# Verify-ready Prompt: 4-2/task-54
...
- Phase：`phase-4`
- Task 标识：`4-2/task-54`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-54-s3-03-c3-09-ai-privacy-rules.md`
...
- Manifest 章节：`## 4-2/task-54`
- 依赖任务：`4-2/task-53, 4-2/task-45`
- 风险等级：`High`
- 绑定 UX 页面：`S3-03-remote-model-enable`
- 绑定 Core 能力：`C3-09`
- Control map 期望 Core 能力：`S3-03: C3-03, C3-09`
- 当前 task 覆盖 Core 能力：`C3-09`
- Secondary capability 状态：`C3-03（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-54-s3-03-c3-09-ai-privacy-rules.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-54`
