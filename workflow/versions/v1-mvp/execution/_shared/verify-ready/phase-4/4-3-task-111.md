# Verify-ready Prompt: 4-3/task-111
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-111`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-111-s4-ios-04-c4-05-share-extension-import.md`
...
- Manifest 章节：`## 4-3/task-111`
- 依赖任务：`4-3/task-110, 4-3/task-25`
- 风险等级：`High`
- 绑定 UX 页面：`S4-IOS-04-share-extension-import`
- 绑定 Core 能力：`C4-05`
- Control map 期望 Core 能力：`S4-IOS-04: C4-05`
- 当前 task 覆盖 Core 能力：`C4-05`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-111-s4-ios-04-c4-05-share-extension-import.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-111`
