# Verify-ready Prompt: 4-3/task-105
...
- Phase：`phase-4`
- Task 标识：`4-3/task-105`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-105-c4-21-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-105`
- 依赖任务：`4-3/task-104`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S4-IOS-07-files-import, S4-WIN-05-import-flow, S4-LNX-05-import-flow, S4-X-01-sync-conflict, S4-X-09-replace-confirm`
- 绑定 Core 能力：`C4-21`
- Control map 期望 Core 能力：`S4-IOS-07: C4-06, C4-21; S4-WIN-05: C4-13, C4-21; S4-LNX-05: C4-13, C4-21; S4-X-01: C4-15, C4-16, C4-21; S4-X-09: C4-16, C4-21`
- 当前 task 覆盖 Core 能力：`C4-21`
- Secondary capability 状态：`消费页面中的其他能力不属于当前 Core task 验收范围；仅检查当前能力是否满足这些页面对该能力的需求`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `8` 个，现有代码 `2` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-105-c4-21-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-105`
