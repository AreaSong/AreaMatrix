# Verify-ready Prompt: 4-2/task-51
...
- Phase：`phase-4`
- Task 标识：`4-2/task-51`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-51-s3-01-c3-01-ai-settings-config.md`
...
- Manifest 章节：`## 4-2/task-51`
- 依赖任务：`4-2/task-50, 4-2/task-05`
- 风险等级：`High`
- 绑定 UX 页面：`S3-01-ai-settings`
- 绑定 Core 能力：`C3-01`
- Control map 期望 Core 能力：`S3-01: C3-01`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-51-s3-01-c3-01-ai-settings-config.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-51`
