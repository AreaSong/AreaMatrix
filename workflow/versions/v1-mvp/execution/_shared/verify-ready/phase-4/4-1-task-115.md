# Verify-ready Prompt: 4-1/task-115
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-115`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-115-s2-12-c2-08-batch-change-category.md`
...
- Manifest 章节：`## 4-1/task-115`
- 依赖任务：`4-1/task-114, 4-1/task-40`
- 风险等级：`High`
- 绑定 UX 页面：`S2-12-batch-change-category`
- 绑定 Core 能力：`C2-08`
- Control map 期望 Core 能力：`S2-12: C2-08, C2-07`
- 当前 task 覆盖 Core 能力：`C2-08`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-115-s2-12-c2-08-batch-change-category.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-115`
