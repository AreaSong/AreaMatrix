# Verify-ready Prompt: 4-3/task-113
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-113`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-113-s4-ios-06-c4-08-cloud-permission-state.md`
...
- Manifest 章节：`## 4-3/task-113`
- 依赖任务：`4-3/task-112, 4-3/task-40`
- 风险等级：`High`
- 绑定 UX 页面：`S4-IOS-06-icloud-permission`
- 绑定 Core 能力：`C4-08`
- Control map 期望 Core 能力：`S4-IOS-06: C4-08`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-113-s4-ios-06-c4-08-cloud-permission-state.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-113`
