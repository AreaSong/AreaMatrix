# Verify-ready Prompt: 4-3/task-07
...
- Phase：`phase-4`
- Task 标识：`4-3/task-07`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-07-c4-02-implementation.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-07-c4-02-implementation.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-07`
