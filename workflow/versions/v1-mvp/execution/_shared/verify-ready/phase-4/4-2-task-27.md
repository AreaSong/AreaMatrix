# Verify-ready Prompt: 4-2/task-27
...
- Phase：`phase-4`
- Task 标识：`4-2/task-27`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-27-c3-06-implementation.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-27-c3-06-implementation.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-27`
