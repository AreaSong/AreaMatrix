# Verify-ready Prompt: 4-1/task-134
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-134`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-134-s2-21-c2-17-import-conflict-batch.md`
...
- Manifest 章节：`## 4-1/task-134`
- 依赖任务：`4-1/task-133, 4-1/task-85`
- 风险等级：`High`
- 绑定 UX 页面：`S2-21-import-conflict-batch`
- 绑定 Core 能力：`C2-17`
- Control map 期望 Core 能力：`S2-21: C2-17, C2-07`
- 当前 task 覆盖 Core 能力：`C2-17`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-134-s2-21-c2-17-import-conflict-batch.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-134`
