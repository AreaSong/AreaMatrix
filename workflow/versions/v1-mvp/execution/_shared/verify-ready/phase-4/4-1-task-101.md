# Verify-ready Prompt: 4-1/task-101
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-101`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-101-s2-04-c2-01-search-query-files.md`
...
- Manifest 章节：`## 4-1/task-101`
- 依赖任务：`4-1/task-100, 4-1/task-05`
- 风险等级：`High`
- 绑定 UX 页面：`S2-04-search-empty`
- 绑定 Core 能力：`C2-01`
- Control map 期望 Core 能力：`S2-04: C2-01`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-101-s2-04-c2-01-search-query-files.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-101`
