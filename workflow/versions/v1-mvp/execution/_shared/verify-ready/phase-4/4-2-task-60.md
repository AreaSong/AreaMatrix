# Verify-ready Prompt: 4-2/task-60
...
- Phase：`phase-4`
- Task 标识：`4-2/task-60`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-60-s3-05-c3-05-ai-call-log.md`
...
- Manifest 章节：`## 4-2/task-60`
- 依赖任务：`4-2/task-59, 4-2/task-25`
- 风险等级：`High`
- 绑定 UX 页面：`S3-05-ai-call-log`
- 绑定 Core 能力：`C3-05`
- Control map 期望 Core 能力：`S3-05: C3-05`
- 当前 task 覆盖 Core 能力：`C3-05`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-60-s3-05-c3-05-ai-call-log.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-60`
