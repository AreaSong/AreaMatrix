# Verify-ready Prompt: 4-3/task-160
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-160`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-160-s4-x-08-c4-20-repository-settings-cross-platform.md`
...
- Manifest 章节：`## 4-3/task-160`
- 依赖任务：`4-3/task-159, 4-3/task-100`
- 风险等级：`High`
- 绑定 UX 页面：`S4-X-08-repository-settings`
- 绑定 Core 能力：`C4-20`
- Control map 期望 Core 能力：`S4-X-08: C4-17, C4-20`
- 当前 task 覆盖 Core 能力：`C4-20`
- Secondary capability 状态：`C4-17（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-160-s4-x-08-c4-20-repository-settings-cross-platform.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-160`
