# Verify-ready Prompt: 4-3/task-130
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-130`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-130-s4-lnx-01-c4-10-linux-repo-connect.md`
...
- Manifest 章节：`## 4-3/task-130`
- 依赖任务：`4-3/task-129, 4-3/task-50`
- 风险等级：`High`
- 绑定 UX 页面：`S4-LNX-01-choose-repo`
- 绑定 Core 能力：`C4-10`
- Control map 期望 Core 能力：`S4-LNX-01: C4-10`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-130-s4-lnx-01-c4-10-linux-repo-connect.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-130`
