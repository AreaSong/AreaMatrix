# Verify-ready Prompt: 4-3/task-80
...
- Phase：`phase-4`
- Task 标识：`4-3/task-80`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-80-c4-16-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-80`
- 依赖任务：`4-3/task-79`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S4-X-01-sync-conflict, S4-X-09-replace-confirm`
- 绑定 Core 能力：`C4-16`
- Control map 期望 Core 能力：`S4-X-01: C4-15, C4-16, C4-21; S4-X-09: C4-16, C4-21`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-80-c4-16-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-80`
