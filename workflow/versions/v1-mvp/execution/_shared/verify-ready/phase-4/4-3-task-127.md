# Verify-ready Prompt: 4-3/task-127
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-127`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-127-s4-win-05-c4-13-desktop-import-flow.md`
...
- Manifest 章节：`## 4-3/task-127`
- 依赖任务：`4-3/task-126, 4-3/task-65`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-127-s4-win-05-c4-13-desktop-import-flow.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-127`
