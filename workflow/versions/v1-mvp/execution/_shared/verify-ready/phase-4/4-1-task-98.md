# Verify-ready Prompt: 4-1/task-98
...
- Phase：`phase-4`
- Task 标识：`4-1/task-98`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-98-s2-01-page-integration-verify.md`
...
- Manifest 章节：`## 4-1/task-98`
- 依赖任务：`4-1/task-96, 4-1/task-97`
- 风险等级：`High`
- 绑定 UX 页面：`S2-01-search-results`
- 绑定 Core 能力：`C2-01, C2-02`
- Control map 期望 Core 能力：`S2-01: C2-01, C2-02`
- 当前 task 覆盖 Core 能力：`C2-01, C2-02`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-98-s2-01-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-98`
