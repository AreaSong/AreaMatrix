# Verify-ready Prompt: 4-3/task-132
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-132`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-132-s4-lnx-03-c4-10-linux-repo-connect.md`
...
- Manifest 章节：`## 4-3/task-132`
- 依赖任务：`4-3/task-131, 4-3/task-50`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-132-s4-lnx-03-c4-10-linux-repo-connect.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-132`
