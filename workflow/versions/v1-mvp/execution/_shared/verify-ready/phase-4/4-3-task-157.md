# Verify-ready Prompt: 4-3/task-157
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-157`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-157-s4-x-06-c4-18-missing-file-recovery.md`
...
- Manifest 章节：`## 4-3/task-157`
- 依赖任务：`4-3/task-156, 4-3/task-90`
- 风险等级：`High`
- 绑定 UX 页面：`S4-X-06-missing-file-recovery`
- 绑定 Core 能力：`C4-18`
- Control map 期望 Core 能力：`S4-X-06: C4-18`
- 当前 task 覆盖 Core 能力：`C4-18`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-157-s4-x-06-c4-18-missing-file-recovery.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-157`
