# Verify-ready Prompt: 4-3/task-135
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-135`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-135-s4-lnx-04-c4-12-platform-watcher-status.md`
...
- Manifest 章节：`## 4-3/task-135`
- 依赖任务：`4-3/task-134, 4-3/task-60`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-135-s4-lnx-04-c4-12-platform-watcher-status.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-135`
