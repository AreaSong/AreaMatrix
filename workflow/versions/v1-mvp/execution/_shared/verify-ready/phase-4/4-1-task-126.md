# Verify-ready Prompt: 4-1/task-126
...
- Phase：`phase-4`
- Task 标识：`4-1/task-126`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-126-s2-15-page-integration-verify.md`
...
- Manifest 章节：`## 4-1/task-126`
- 依赖任务：`4-1/task-124, 4-1/task-125`
- 风险等级：`High`
- 绑定 UX 页面：`S2-15-command-palette`
- 绑定 Core 能力：`C2-04, C2-11`
- Control map 期望 Core 能力：`S2-15: C2-04, C2-11`
- 当前 task 覆盖 Core 能力：`C2-04, C2-11`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-126-s2-15-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-126`
