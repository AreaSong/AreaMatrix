# Verify-ready Prompt: 4-3/task-55
...
- Phase：`phase-4`
- Task 标识：`4-3/task-55`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-55-c4-11-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-55`
- 依赖任务：`4-3/task-54`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S4-WIN-02-main-window, S4-LNX-02-main-window`
- 绑定 Core 能力：`C4-11`
- Control map 期望 Core 能力：`S4-WIN-02: C4-11; S4-LNX-02: C4-11`
- 当前 task 覆盖 Core 能力：`C4-11`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-55-c4-11-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-55`
