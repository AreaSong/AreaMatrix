# Verify-ready Prompt: 4-3/task-95
...
- Phase：`phase-4`
- Task 标识：`4-3/task-95`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-95-c4-19-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-95`
- 依赖任务：`4-3/task-94`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S4-WIN-04-watcher-status, S4-LNX-04-watcher-status, S4-X-07-rescan-confirm`
- 绑定 Core 能力：`C4-19`
- Control map 期望 Core 能力：`S4-WIN-04: C4-12, C4-19; S4-LNX-04: C4-12, C4-19; S4-X-07: C4-19`
- 当前 task 覆盖 Core 能力：`C4-19`
- Secondary capability 状态：`消费页面中的其他能力不属于当前 Core task 验收范围；仅检查当前能力是否满足这些页面对该能力的需求`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `6` 个，现有代码 `2` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-95-c4-19-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-95`
