# Verify-ready Prompt: 4-2/task-46
...
- Phase：`phase-4`
- Task 标识：`4-2/task-46`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-46-c3-10-contract-api.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-46-c3-10-contract-api.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-46`
