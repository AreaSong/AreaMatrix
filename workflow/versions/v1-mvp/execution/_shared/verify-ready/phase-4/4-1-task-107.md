# Verify-ready Prompt: 4-1/task-107
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-107`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-107-s2-08-c2-02-search-filters.md`
...
- Manifest 章节：`## 4-1/task-107`
- 依赖任务：`4-1/task-106, 4-1/task-10`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-107-s2-08-c2-02-search-filters.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-107`
