# Verify-ready Prompt: 4-3/task-110
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-110`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-110-s4-ios-03-c4-04-camera-import.md`
...
- Manifest 章节：`## 4-3/task-110`
- 依赖任务：`4-3/task-109, 4-3/task-20`
- 风险等级：`High`
- 绑定 UX 页面：`S4-IOS-03-camera-import`
- 绑定 Core 能力：`C4-04`
- Control map 期望 Core 能力：`S4-IOS-03: C4-04`
- 当前 task 覆盖 Core 能力：`C4-04`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-110-s4-ios-03-c4-04-camera-import.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-110`
