# Verify-ready Prompt: 4-3/task-141
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-141`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-141-s4-x-01-c4-15-sync-conflict-detect.md`
...
- Manifest 章节：`## 4-3/task-141`
- 依赖任务：`4-3/task-140, 4-3/task-75`
- 风险等级：`High`
- 绑定 UX 页面：`S4-X-01-sync-conflict`
- 绑定 Core 能力：`C4-15`
- Control map 期望 Core 能力：`S4-X-01: C4-15, C4-16, C4-21`
- 当前 task 覆盖 Core 能力：`C4-15`
- Secondary capability 状态：`C4-16, C4-21（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-141-s4-x-01-c4-15-sync-conflict-detect.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-141`
