# Verify-ready Prompt: 4-1/task-15
...
- Phase：`phase-4`
- Task 标识：`4-1/task-15`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-15-c2-03-integration-verify.md`
...
- Manifest 章节：`## 4-1/task-15`
- 依赖任务：`4-1/task-14`
- 风险等级：`High`
- 绑定 UX 页面：`S2-03-saved-search-sheet, S2-06-smart-lists`
- 绑定 Core 能力：`C2-03`
- Control map 期望 Core 能力：`S2-03: C2-03; S2-06: C2-03, C2-04`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-15-c2-03-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-15`
