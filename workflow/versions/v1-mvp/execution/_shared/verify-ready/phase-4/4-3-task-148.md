# Verify-ready Prompt: 4-3/task-148
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-148`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-148-s4-x-03-c4-15-sync-conflict-detect.md`
...
- Manifest 章节：`## 4-3/task-148`
- 依赖任务：`4-3/task-147, 4-3/task-75`
- 风险等级：`High`
- 绑定 UX 页面：`S4-X-03-sync-conflict-entry`
- 绑定 Core 能力：`C4-15`
- Control map 期望 Core 能力：`S4-X-03: C4-15`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-148-s4-x-03-c4-15-sync-conflict-detect.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-148`
