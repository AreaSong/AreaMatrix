# Verify-ready Prompt: 4-3/task-161
...
- Phase：`phase-4`
- Task 标识：`4-3/task-161`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-161-s4-x-08-page-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-161`
- 依赖任务：`4-3/task-159, 4-3/task-160`
- 风险等级：`High`
- 绑定 UX 页面：`S4-X-08-repository-settings`
- 绑定 Core 能力：`C4-17, C4-20`
- Control map 期望 Core 能力：`S4-X-08: C4-17, C4-20`
- 当前 task 覆盖 Core 能力：`C4-17, C4-20`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-161-s4-x-08-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-161`
