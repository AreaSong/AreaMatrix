# Verify-ready Prompt: 4-3/task-137
...
- Phase：`phase-4`
- Task 标识：`4-3/task-137`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-137-s4-lnx-04-page-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-137`
- 依赖任务：`4-3/task-135, 4-3/task-136`
- 风险等级：`High`
- 绑定 UX 页面：`S4-LNX-04-watcher-status`
- 绑定 Core 能力：`C4-12, C4-19`
- Control map 期望 Core 能力：`S4-LNX-04: C4-12, C4-19`
- 当前 task 覆盖 Core 能力：`C4-12, C4-19`
- Secondary capability 状态：`None`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `5` 个，现有代码 `2` 项，预期新增路径 `1` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-137-s4-lnx-04-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-137`
