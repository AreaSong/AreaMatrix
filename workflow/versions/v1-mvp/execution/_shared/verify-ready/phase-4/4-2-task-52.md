# Verify-ready Prompt: 4-2/task-52
...
- Phase：`phase-4`
- Task 标识：`4-2/task-52`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-52-s3-02-c3-02-local-model-status.md`
...
- Manifest 章节：`## 4-2/task-52`
- 依赖任务：`4-2/task-51, 4-2/task-10`
- 风险等级：`High`
- 绑定 UX 页面：`S3-02-local-model-status`
- 绑定 Core 能力：`C3-02`
- Control map 期望 Core 能力：`S3-02: C3-02`
- 当前 task 覆盖 Core 能力：`C3-02`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-52-s3-02-c3-02-local-model-status.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-52`
