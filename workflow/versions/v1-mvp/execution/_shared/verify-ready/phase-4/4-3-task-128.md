# Verify-ready Prompt: 4-3/task-128
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-128`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-128-s4-win-05-c4-21-replace-confirm-cross-platform.md`
...
- Manifest 章节：`## 4-3/task-128`
- 依赖任务：`4-3/task-127, 4-3/task-105`
- 风险等级：`High`
- 绑定 UX 页面：`S4-WIN-05-import-flow`
- 绑定 Core 能力：`C4-21`
- Control map 期望 Core 能力：`S4-WIN-05: C4-13, C4-21`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-128-s4-win-05-c4-21-replace-confirm-cross-platform.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-128`
