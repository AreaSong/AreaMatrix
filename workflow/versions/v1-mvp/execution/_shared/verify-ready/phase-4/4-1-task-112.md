# Verify-ready Prompt: 4-1/task-112
...
- Phase：`phase-4`
- Task 标识：`4-1/task-112`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-112-s2-09-page-integration-verify.md`
...
- Manifest 章节：`## 4-1/task-112`
- 依赖任务：`4-1/task-110, 4-1/task-111`
- 风险等级：`High`
- 绑定 UX 页面：`S2-09-batch-add-tags`
- 绑定 Core 能力：`C2-06, C2-07`
- Control map 期望 Core 能力：`S2-09: C2-06, C2-07`
- 当前 task 覆盖 Core 能力：`C2-06, C2-07`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-112-s2-09-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-112`
