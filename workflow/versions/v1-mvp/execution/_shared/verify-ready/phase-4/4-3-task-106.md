# Verify-ready Prompt: 4-3/task-106
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-106`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-106-s4-ios-01-c4-02-mobile-repo-connect.md`
...
- Manifest 章节：`## 4-3/task-106`
- 依赖任务：`4-3/task-105, 4-3/task-10`
- 风险等级：`High`
- 绑定 UX 页面：`S4-IOS-01-connect-repo`
- 绑定 Core 能力：`C4-02`
- Control map 期望 Core 能力：`S4-IOS-01: C4-02, C4-08`
- 当前 task 覆盖 Core 能力：`C4-02`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-106-s4-ios-01-c4-02-mobile-repo-connect.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-106`
