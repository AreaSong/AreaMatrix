# Verify-ready Prompt: 4-1/task-137
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-137`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-137-s2-22-c2-18-redo-action-log.md`
...
- Manifest 章节：`## 4-1/task-137`
- 依赖任务：`4-1/task-136, 4-1/task-90`
- 风险等级：`High`
- 绑定 UX 页面：`S2-22-redo`
- 绑定 Core 能力：`C2-18`
- Control map 期望 Core 能力：`S2-22: C2-18, C2-07`
- 当前 task 覆盖 Core 能力：`C2-18`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-137-s2-22-c2-18-redo-action-log.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-137`
