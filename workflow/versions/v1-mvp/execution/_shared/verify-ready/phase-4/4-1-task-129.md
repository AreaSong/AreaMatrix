# Verify-ready Prompt: 4-1/task-129
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-129`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-129-s2-18-c2-14-classifier-impact-preview.md`
...
- Manifest 章节：`## 4-1/task-129`
- 依赖任务：`4-1/task-128, 4-1/task-70`
- 风险等级：`High`
- 绑定 UX 页面：`S2-18-classifier-impact-preview`
- 绑定 Core 能力：`C2-14`
- Control map 期望 Core 能力：`S2-18: C2-14`
- 当前 task 覆盖 Core 能力：`C2-14`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-129-s2-18-c2-14-classifier-impact-preview.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-129`
