# Verify-ready Prompt: 4-3/task-153
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-153`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-153-s4-x-05-c4-02-mobile-repo-connect.md`
...
- Manifest 章节：`## 4-3/task-153`
- 依赖任务：`4-3/task-152, 4-3/task-10`
- 风险等级：`High`
- 绑定 UX 页面：`S4-X-05-repository-adopt-confirm`
- 绑定 Core 能力：`C4-02`
- Control map 期望 Core 能力：`S4-X-05: C4-02, C4-09, C4-10`
- 当前 task 覆盖 Core 能力：`C4-02`
- Secondary capability 状态：`C4-09, C4-10（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-153-s4-x-05-c4-02-mobile-repo-connect.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-153`
