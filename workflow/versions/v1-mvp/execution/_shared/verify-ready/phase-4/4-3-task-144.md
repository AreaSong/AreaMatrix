# Verify-ready Prompt: 4-3/task-144
...
- Phase：`phase-4`
- Task 标识：`4-3/task-144`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-144-s4-x-01-page-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-144`
- 依赖任务：`4-3/task-141, 4-3/task-142, 4-3/task-143`
- 风险等级：`High`
- 绑定 UX 页面：`S4-X-01-sync-conflict`
- 绑定 Core 能力：`C4-15, C4-16, C4-21`
- Control map 期望 Core 能力：`S4-X-01: C4-15, C4-16, C4-21`
- 当前 task 覆盖 Core 能力：`C4-15, C4-16, C4-21`
- Secondary capability 状态：`None`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `6` 个，现有代码 `2` 项，预期新增路径 `1` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-144-s4-x-01-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-144`
