# Verify-ready Prompt: 4-1/task-132
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-132`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-132-s2-20-c1-25-25-list-icloud-conflicts.md`
...
- Manifest 章节：`## 4-1/task-132`
- 依赖任务：`4-1/task-131, 1-5/task-20`
- 风险等级：`High`
- 绑定 UX 页面：`S2-20-icloud-conflict-visual`
- 绑定 Core 能力：`C1-25`
- Control map 期望 Core 能力：`S2-20: C2-16, C1-25`
- 当前 task 覆盖 Core 能力：`C1-25`
- Secondary capability 状态：`C2-16（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-132-s2-20-c1-25-25-list-icloud-conflicts.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-132`
