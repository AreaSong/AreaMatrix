# Verify-ready Prompt: 4-3/task-146
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-146`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-146-s4-x-02-c4-17-platform-capabilities.md`
...
- Manifest 章节：`## 4-3/task-146`
- 依赖任务：`4-3/task-145, 4-3/task-85`
- 风险等级：`High`
- 绑定 UX 页面：`S4-X-02-platform-differences`
- 绑定 Core 能力：`C4-17`
- Control map 期望 Core 能力：`S4-X-02: C4-01, C4-17`
- 当前 task 覆盖 Core 能力：`C4-17`
- Secondary capability 状态：`C4-01（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-146-s4-x-02-c4-17-platform-capabilities.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-146`
