# Verify-ready Prompt: 4-1/task-139
...
- Phase：`phase-4`
- Task 标识：`4-1/task-139`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-139-s2-22-page-integration-verify.md`
...
- Manifest 章节：`## 4-1/task-139`
- 依赖任务：`4-1/task-137, 4-1/task-138`
- 风险等级：`High`
- 绑定 UX 页面：`S2-22-redo`
- 绑定 Core 能力：`C2-18, C2-07`
- Control map 期望 Core 能力：`S2-22: C2-18, C2-07`
- 当前 task 覆盖 Core 能力：`C2-07, C2-18`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-139-s2-22-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-139`
