# Verify-ready Prompt: 4-2/task-05
...
- Phase：`phase-4`
- Task 标识：`4-2/task-05`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-05-c3-01-integration-verify.md`
...
- Manifest 章节：`## 4-2/task-05`
- 依赖任务：`4-2/task-04`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S3-01-ai-settings, S3-09-ai-privacy-rules`
- 绑定 Core 能力：`C3-01`
- Control map 期望 Core 能力：`S3-01: C3-01; S3-09: C3-01, C3-03, C3-09`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-05-c3-01-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-05`
