# Verify-ready Prompt: 4-2/task-77
...
- Phase：`phase-4`
- Task 标识：`4-2/task-77`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-77-s3-10-c3-10-ai-fallback.md`
...
- Manifest 章节：`## 4-2/task-77`
- 依赖任务：`4-2/task-76, 4-2/task-50`
- 风险等级：`High`
- 绑定 UX 页面：`S3-10-ai-fallback`
- 绑定 Core 能力：`C3-10`
- Control map 期望 Core 能力：`S3-10: C3-04, C3-08, C3-10`
- 当前 task 覆盖 Core 能力：`C3-10`
- Secondary capability 状态：`C3-04, C3-08（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-77-s3-10-c3-10-ai-fallback.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-77`
