# Verify-ready Prompt: 4-3/task-131
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-131`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-131-s4-lnx-02-c4-11-desktop-main-query.md`
...
- Manifest 章节：`## 4-3/task-131`
- 依赖任务：`4-3/task-130, 4-3/task-55`
- 风险等级：`High`
- 绑定 UX 页面：`S4-LNX-02-main-window`
- 绑定 Core 能力：`C4-11`
- Control map 期望 Core 能力：`S4-LNX-02: C4-11`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-131-s4-lnx-02-c4-11-desktop-main-query.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-131`
