# Verify-ready Prompt: 4-1/task-120
...
- Phase：`phase-4`
- Task 标识：`4-1/task-120`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-120-s2-13-page-integration-verify.md`
...
- Manifest 章节：`## 4-1/task-120`
- 依赖任务：`4-1/task-118, 4-1/task-119`
- 风险等级：`High`
- 绑定 UX 页面：`S2-13-batch-delete-confirm`
- 绑定 Core 能力：`C2-09, C2-07`
- Control map 期望 Core 能力：`S2-13: C2-09, C2-07`
- 当前 task 覆盖 Core 能力：`C2-07, C2-09`
- Secondary capability 状态：`None`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `5` 个，现有代码 `2` 项，预期新增路径 `2` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-120-s2-13-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-120`
