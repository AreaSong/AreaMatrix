# Verify-ready Prompt: 4-3/task-165
...
- 任务细分：`stage-verify`
- Phase：`phase-4`
- Task 标识：`4-3/task-165`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-165-stage-4-multiplatform-integration-verify.md`
...
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `4` 个，现有代码 `3` 项，预期新增路径 `7` 项，禁止触碰路径 `5` 项，验证命令 `3` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-165-stage-4-multiplatform-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-165`
