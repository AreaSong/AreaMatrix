# Verify-ready Prompt: 4-1/task-125
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-125`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-125-s2-15-c2-11-command-index.md`
...
- Manifest 章节：`## 4-1/task-125`
- 依赖任务：`4-1/task-124, 4-1/task-55`
- 风险等级：`High`
- 绑定 UX 页面：`S2-15-command-palette`
- 绑定 Core 能力：`C2-11`
- Control map 期望 Core 能力：`S2-15: C2-04, C2-11`
- 当前 task 覆盖 Core 能力：`C2-11`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-125-s2-15-c2-11-command-index.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-125`
