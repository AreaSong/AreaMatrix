# Verify-ready Prompt: 4-1/task-100
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-100`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-100-s2-03-c2-03-saved-search-crud.md`
...
- Manifest 章节：`## 4-1/task-100`
- 依赖任务：`4-1/task-99, 4-1/task-15`
- 风险等级：`High`
- 绑定 UX 页面：`S2-03-saved-search-sheet`
- 绑定 Core 能力：`C2-03`
- Control map 期望 Core 能力：`S2-03: C2-03`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-100-s2-03-c2-03-saved-search-crud.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-100`
