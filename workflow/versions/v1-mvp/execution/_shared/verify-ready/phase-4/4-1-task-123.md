# Verify-ready Prompt: 4-1/task-123
...
- Phase：`phase-4`
- Task 标识：`4-1/task-123`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-123-s2-14-page-integration-verify.md`
...
- Manifest 章节：`## 4-1/task-123`
- 依赖任务：`4-1/task-121, 4-1/task-122`
- 风险等级：`High`
- 绑定 UX 页面：`S2-14-batch-rename`
- 绑定 Core 能力：`C2-10, C2-07`
- Control map 期望 Core 能力：`S2-14: C2-10, C2-07`
- 当前 task 覆盖 Core 能力：`C2-07, C2-10`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-123-s2-14-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-123`
