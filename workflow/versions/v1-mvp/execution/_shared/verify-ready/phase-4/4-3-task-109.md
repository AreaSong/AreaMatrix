# Verify-ready Prompt: 4-3/task-109
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-109`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-109-s4-ios-02-c4-03-mobile-library-query.md`
...
- Manifest 章节：`## 4-3/task-109`
- 依赖任务：`4-3/task-108, 4-3/task-15`
- 风险等级：`High`
- 绑定 UX 页面：`S4-IOS-02-mobile-library`
- 绑定 Core 能力：`C4-03`
- Control map 期望 Core 能力：`S4-IOS-02: C4-03`
- 当前 task 覆盖 Core 能力：`C4-03`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-109-s4-ios-02-c4-03-mobile-library-query.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-109`
