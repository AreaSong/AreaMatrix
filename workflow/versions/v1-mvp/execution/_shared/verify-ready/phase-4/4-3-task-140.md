# Verify-ready Prompt: 4-3/task-140
...
- Phase：`phase-4`
- Task 标识：`4-3/task-140`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-140-s4-lnx-05-page-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-140`
- 依赖任务：`4-3/task-138, 4-3/task-139`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-140-s4-lnx-05-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-140`
