# Verify-ready Prompt: 4-1/task-106
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-106`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-106-s2-07-c2-05-tag-crud.md`
...
- Manifest 章节：`## 4-1/task-106`
- 依赖任务：`4-1/task-105, 4-1/task-25`
- 风险等级：`High`
- 绑定 UX 页面：`S2-07-tags-add`
- 绑定 Core 能力：`C2-05`
- Control map 期望 Core 能力：`S2-07: C2-05`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-106-s2-07-c2-05-tag-crud.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-106`
