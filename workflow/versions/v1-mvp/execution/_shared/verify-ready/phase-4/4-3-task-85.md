# Verify-ready Prompt: 4-3/task-85
...
- Phase：`phase-4`
- Task 标识：`4-3/task-85`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-85-c4-17-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-85`
- 依赖任务：`4-3/task-84`
- 风险等级：`High`
- 绑定 UX 页面：`S4-LNX-03-local-folder-notice, S4-X-02-platform-differences, S4-X-08-repository-settings`
- 绑定 Core 能力：`C4-17`
- Control map 期望 Core 能力：`S4-LNX-03: C4-10, C4-17; S4-X-02: C4-01, C4-17; S4-X-08: C4-17, C4-20`
- 当前 task 覆盖 Core 能力：`C4-17`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-85-c4-17-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-85`
