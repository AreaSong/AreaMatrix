# Verify-ready Prompt: 4-3/task-65
...
- Phase：`phase-4`
- Task 标识：`4-3/task-65`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-65-c4-13-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-65`
- 依赖任务：`4-3/task-64`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S4-WIN-05-import-flow, S4-LNX-05-import-flow`
- 绑定 Core 能力：`C4-13`
- Control map 期望 Core 能力：`S4-WIN-05: C4-13, C4-21; S4-LNX-05: C4-13, C4-21`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-65-c4-13-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-65`
