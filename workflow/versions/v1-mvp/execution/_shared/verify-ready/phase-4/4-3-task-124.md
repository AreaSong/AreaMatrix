# Verify-ready Prompt: 4-3/task-124
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-124`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-124-s4-win-04-c4-12-platform-watcher-status.md`
...
- Manifest 章节：`## 4-3/task-124`
- 依赖任务：`4-3/task-123, 4-3/task-60`
- 风险等级：`High`
- 绑定 UX 页面：`S4-WIN-04-watcher-status`
- 绑定 Core 能力：`C4-12`
- Control map 期望 Core 能力：`S4-WIN-04: C4-12, C4-19`
- 当前 task 覆盖 Core 能力：`C4-12`
- Secondary capability 状态：`C4-19（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-124-s4-win-04-c4-12-platform-watcher-status.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-124`
