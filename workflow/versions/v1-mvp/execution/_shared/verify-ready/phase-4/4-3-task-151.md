# Verify-ready Prompt: 4-3/task-151
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-151`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-151-s4-x-04-c4-10-linux-repo-connect.md`
...
- Manifest 章节：`## 4-3/task-151`
- 依赖任务：`4-3/task-150, 4-3/task-50`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-151-s4-x-04-c4-10-linux-repo-connect.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-151`
