# Verify-ready Prompt: 4-3/task-118
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-118`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-118-s4-win-01-c4-14-onedrive-risk-state.md`
...
- Manifest 章节：`## 4-3/task-118`
- 依赖任务：`4-3/task-117, 4-3/task-70`
- 风险等级：`High`
- 绑定 UX 页面：`S4-WIN-01-choose-repo`
- 绑定 Core 能力：`C4-14`
- Control map 期望 Core 能力：`S4-WIN-01: C4-09, C4-14`
- 当前 task 覆盖 Core 能力：`C4-14`
- Secondary capability 状态：`C4-09（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-118-s4-win-01-c4-14-onedrive-risk-state.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-118`
