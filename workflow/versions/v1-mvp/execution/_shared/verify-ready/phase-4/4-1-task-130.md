# Verify-ready Prompt: 4-1/task-130
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-130`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-130-s2-19-c2-15-classifier-rule-editor.md`
...
- Manifest 章节：`## 4-1/task-130`
- 依赖任务：`4-1/task-129, 4-1/task-75`
- 风险等级：`High`
- 绑定 UX 页面：`S2-19-classifier-rule-editor`
- 绑定 Core 能力：`C2-15`
- Control map 期望 Core 能力：`S2-19: C2-15`
- 当前 task 覆盖 Core 能力：`C2-15`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-130-s2-19-c2-15-classifier-rule-editor.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-130`
