# Verify-ready Prompt: 4-1/task-25
...
- Phase：`phase-4`
- Task 标识：`4-1/task-25`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-25-c2-05-integration-verify.md`
...
- Manifest 章节：`## 4-1/task-25`
- 依赖任务：`4-1/task-24`
- 风险等级：`High`
- 绑定 UX 页面：`S2-07-tags-add, S2-08-tags-filter, S2-23-tag-suggestions`
- 绑定 Core 能力：`C2-05`
- Control map 期望 Core 能力：`S2-07: C2-05; S2-08: C2-02, C2-05; S2-23: C2-19, C2-05`
- 当前 task 覆盖 Core 能力：`C2-05`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-25-c2-05-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-25`
