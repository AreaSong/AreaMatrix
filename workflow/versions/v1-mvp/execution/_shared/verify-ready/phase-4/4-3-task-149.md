# Verify-ready Prompt: 4-3/task-149
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-149`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-149-s4-x-04-c4-02-mobile-repo-connect.md`
...
- Manifest 章节：`## 4-3/task-149`
- 依赖任务：`4-3/task-148, 4-3/task-10`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-149-s4-x-04-c4-02-mobile-repo-connect.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-149`
