# Verify-ready Prompt: 4-2/task-71
...
- Phase：`phase-4`
- Task 标识：`4-2/task-71`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-71-s3-09-c3-01-ai-settings-config.md`
...
- Manifest 章节：`## 4-2/task-71`
- 依赖任务：`4-2/task-70, 4-2/task-05`
- 风险等级：`High`
- 绑定 UX 页面：`S3-09-ai-privacy-rules`
- 绑定 Core 能力：`C3-01`
- Control map 期望 Core 能力：`S3-09: C3-01, C3-03, C3-09`
- 当前 task 覆盖 Core 能力：`C3-01`
- Secondary capability 状态：`C3-03, C3-09（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-71-s3-09-c3-01-ai-settings-config.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-71`
