# Verify-ready Prompt: 4-1/task-119
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-119`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-119-s2-13-c2-07-undo-action-log.md`
...
- Manifest 章节：`## 4-1/task-119`
- 依赖任务：`4-1/task-118, 4-1/task-35`
- 风险等级：`High`
- 绑定 UX 页面：`S2-13-batch-delete-confirm`
- 绑定 Core 能力：`C2-07`
- Control map 期望 Core 能力：`S2-13: C2-09, C2-07`
- 当前 task 覆盖 Core 能力：`C2-07`
- Secondary capability 状态：`C2-09（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-119-s2-13-c2-07-undo-action-log.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-119`
