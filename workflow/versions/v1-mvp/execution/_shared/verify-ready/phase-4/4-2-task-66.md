# Verify-ready Prompt: 4-2/task-66
...
- Phase：`phase-4`
- Task 标识：`4-2/task-66`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-66-s3-07-page-integration-verify.md`
...
- Manifest 章节：`## 4-2/task-66`
- 依赖任务：`4-2/task-64, 4-2/task-65`
- 风险等级：`High`
- 绑定 UX 页面：`S3-07-ai-tags-suggestion`
- 绑定 Core 能力：`C3-07, C3-09`
- Control map 期望 Core 能力：`S3-07: C3-07, C3-09`
- 当前 task 覆盖 Core 能力：`C3-07, C3-09`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-66-s3-07-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-66`
