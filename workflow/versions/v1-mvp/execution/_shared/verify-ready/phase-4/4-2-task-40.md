# Verify-ready Prompt: 4-2/task-40
...
- Phase：`phase-4`
- Task 标识：`4-2/task-40`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-40-c3-08-integration-verify.md`
...
- Manifest 章节：`## 4-2/task-40`
- 依赖任务：`4-2/task-39`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S3-08-semantic-search-results, S3-10-ai-fallback`
- 绑定 Core 能力：`C3-08`
- Control map 期望 Core 能力：`S3-08: C3-08, C3-09, C3-10; S3-10: C3-04, C3-08, C3-10`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-40-c3-08-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-40`
