# Verify-ready Prompt: 4-1/task-118
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-118`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-118-s2-13-c2-09-batch-delete-trash.md`
...
- Manifest 章节：`## 4-1/task-118`
- 依赖任务：`4-1/task-117, 4-1/task-45`
- 风险等级：`High`
- 绑定 UX 页面：`S2-13-batch-delete-confirm`
- 绑定 Core 能力：`C2-09`
- Control map 期望 Core 能力：`S2-13: C2-09, C2-07`
- 当前 task 覆盖 Core 能力：`C2-09`
- Secondary capability 状态：`C2-07（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-118-s2-13-c2-09-batch-delete-trash.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-118`
