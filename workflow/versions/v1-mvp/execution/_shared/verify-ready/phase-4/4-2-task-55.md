# Verify-ready Prompt: 4-2/task-55
...
- Phase：`phase-4`
- Task 标识：`4-2/task-55`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-55-s3-03-page-integration-verify.md`
...
- Manifest 章节：`## 4-2/task-55`
- 依赖任务：`4-2/task-53, 4-2/task-54`
- 风险等级：`High`
- 绑定 UX 页面：`S3-03-remote-model-enable`
- 绑定 Core 能力：`C3-03, C3-09`
- Control map 期望 Core 能力：`S3-03: C3-03, C3-09`
- 当前 task 覆盖 Core 能力：`C3-03, C3-09`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-55-s3-03-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-55`
