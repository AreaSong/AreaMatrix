# Verify-ready Prompt: 4-3/task-136
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-136`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-136-s4-lnx-04-c4-19-manual-rescan.md`
...
- Manifest 章节：`## 4-3/task-136`
- 依赖任务：`4-3/task-135, 4-3/task-95`
- 风险等级：`High`
- 绑定 UX 页面：`S4-LNX-04-watcher-status`
- 绑定 Core 能力：`C4-19`
- Control map 期望 Core 能力：`S4-LNX-04: C4-12, C4-19`
- 当前 task 覆盖 Core 能力：`C4-19`
- Secondary capability 状态：`C4-12（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-136-s4-lnx-04-c4-19-manual-rescan.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-136`
