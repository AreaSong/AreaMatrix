# Verify-ready Prompt: 4-3/task-64
...
- Phase：`phase-4`
- Task 标识：`4-3/task-64`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-64-c4-13-validation.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-64-c4-13-validation.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-64`
