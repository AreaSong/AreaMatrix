# Verify-ready Prompt: 4-3/task-145
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-145`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-145-s4-x-02-c4-01-cross-platform-ffi-contract.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-145-s4-x-02-c4-01-cross-platform-ffi-contract.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-145`
