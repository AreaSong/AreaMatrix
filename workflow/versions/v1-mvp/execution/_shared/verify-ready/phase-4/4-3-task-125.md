# Verify-ready Prompt: 4-3/task-125
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-125`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-125-s4-win-04-c4-19-manual-rescan.md`
...
- Manifest 章节：`## 4-3/task-125`
- 依赖任务：`4-3/task-124, 4-3/task-95`
- 风险等级：`High`
- 绑定 UX 页面：`S4-WIN-04-watcher-status`
- 绑定 Core 能力：`C4-19`
- Control map 期望 Core 能力：`S4-WIN-04: C4-12, C4-19`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-125-s4-win-04-c4-19-manual-rescan.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-125`
