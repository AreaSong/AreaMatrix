# Verify-ready Prompt: 4-2/task-45
...
- Phase：`phase-4`
- Task 标识：`4-2/task-45`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-45-c3-09-integration-verify.md`
...
- Manifest 章节：`## 4-2/task-45`
- 依赖任务：`4-2/task-44`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S3-03-remote-model-enable, S3-04-ai-classification-suggestion, S3-06-ai-summary-editor, S3-07-ai-tags-suggestion, S3-08-semantic-search-results, S3-09-ai-privacy-rules`
- 绑定 Core 能力：`C3-09`
- Control map 期望 Core 能力：`S3-03: C3-03, C3-09; S3-04: C3-04, C3-09, C3-10; S3-06: C3-06, C3-09; S3-07: C3-07, C3-09; S3-08: C3-08, C3-09, C3-10; S3-09: C3-01, C3-03, C3-09`
- 当前 task 覆盖 Core 能力：`C3-09`
- Secondary capability 状态：`消费页面中的其他能力不属于当前 Core task 验收范围；仅检查当前能力是否满足这些页面对该能力的需求`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `9` 个，现有代码 `2` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-45-c3-09-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-45`
