# Verify-ready Prompt: 4-3/task-126
...
- Phase：`phase-4`
- Task 标识：`4-3/task-126`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-126-s4-win-04-page-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-126`
- 依赖任务：`4-3/task-124, 4-3/task-125`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-126-s4-win-04-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-126`
