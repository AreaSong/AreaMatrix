# Verify-ready Prompt: 4-1/task-96
...
- Phase：`phase-4`
- Task 标识：`4-1/task-96`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-96-s2-01-c2-01-search-query-files.md`
...
- Manifest 章节：`## 4-1/task-96`
- 依赖任务：`4-1/task-95, 4-1/task-05`
- 风险等级：`High`
- 绑定 UX 页面：`S2-01-search-results`
- 绑定 Core 能力：`C2-01`
- Control map 期望 Core 能力：`S2-01: C2-01, C2-02`
- 当前 task 覆盖 Core 能力：`C2-01`
- Secondary capability 状态：`C2-02（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-96-s2-01-c2-01-search-query-files.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-96`
