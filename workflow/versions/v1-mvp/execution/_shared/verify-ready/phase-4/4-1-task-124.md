# Verify-ready Prompt: 4-1/task-124
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-124`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-124-s2-15-c2-04-smart-lists.md`
...
- Manifest 章节：`## 4-1/task-124`
- 依赖任务：`4-1/task-123, 4-1/task-20`
- 风险等级：`High`
- 绑定 UX 页面：`S2-15-command-palette`
- 绑定 Core 能力：`C2-04`
- Control map 期望 Core 能力：`S2-15: C2-04, C2-11`
- 当前 task 覆盖 Core 能力：`C2-04`
- Secondary capability 状态：`C2-11（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-124-s2-15-c2-04-smart-lists.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-124`
