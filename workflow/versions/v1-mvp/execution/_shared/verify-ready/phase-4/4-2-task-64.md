# Verify-ready Prompt: 4-2/task-64
...
- Phase：`phase-4`
- Task 标识：`4-2/task-64`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-64-s3-07-c3-07-ai-tags-suggestion.md`
...
- Manifest 章节：`## 4-2/task-64`
- 依赖任务：`4-2/task-63, 4-2/task-35`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-64-s3-07-c3-07-ai-tags-suggestion.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-64`
