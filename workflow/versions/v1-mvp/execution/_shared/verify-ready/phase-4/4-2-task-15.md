# Verify-ready Prompt: 4-2/task-15
...
- Phase：`phase-4`
- Task 标识：`4-2/task-15`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-15-c3-03-integration-verify.md`
...
- Manifest 章节：`## 4-2/task-15`
- 依赖任务：`4-2/task-14`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S3-03-remote-model-enable, S3-09-ai-privacy-rules`
- 绑定 Core 能力：`C3-03`
- Control map 期望 Core 能力：`S3-03: C3-03, C3-09; S3-09: C3-01, C3-03, C3-09`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-15-c3-03-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-15`
