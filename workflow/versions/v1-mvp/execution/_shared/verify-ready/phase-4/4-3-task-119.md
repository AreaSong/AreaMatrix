# Verify-ready Prompt: 4-3/task-119
...
- Phase：`phase-4`
- Task 标识：`4-3/task-119`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-119-s4-win-01-page-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-119`
- 依赖任务：`4-3/task-117, 4-3/task-118`
- 风险等级：`High`
- 绑定 UX 页面：`S4-WIN-01-choose-repo`
- 绑定 Core 能力：`C4-09, C4-14`
- Control map 期望 Core 能力：`S4-WIN-01: C4-09, C4-14`
- 当前 task 覆盖 Core 能力：`C4-09, C4-14`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-119-s4-win-01-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-119`
