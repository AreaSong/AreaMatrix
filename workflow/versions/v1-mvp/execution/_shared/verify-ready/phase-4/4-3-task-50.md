# Verify-ready Prompt: 4-3/task-50
...
- Phase：`phase-4`
- Task 标识：`4-3/task-50`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-50-c4-10-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-50`
- 依赖任务：`4-3/task-49`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S4-LNX-01-choose-repo, S4-LNX-03-local-folder-notice, S4-X-04-repository-init-confirm, S4-X-05-repository-adopt-confirm`
- 绑定 Core 能力：`C4-10`
- Control map 期望 Core 能力：`S4-LNX-01: C4-10; S4-LNX-03: C4-10, C4-17; S4-X-04: C4-02, C4-09, C4-10; S4-X-05: C4-02, C4-09, C4-10`
- 当前 task 覆盖 Core 能力：`C4-10`
- Secondary capability 状态：`消费页面中的其他能力不属于当前 Core task 验收范围；仅检查当前能力是否满足这些页面对该能力的需求`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `7` 个，现有代码 `2` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-50-c4-10-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-50`
