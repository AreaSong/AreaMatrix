# Verify-ready Prompt: 4-3/task-150
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-150`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-150-s4-x-04-c4-09-windows-repo-connect.md`
...
- Manifest 章节：`## 4-3/task-150`
- 依赖任务：`4-3/task-149, 4-3/task-45`
- 风险等级：`High`
- 绑定 UX 页面：`S4-X-04-repository-init-confirm`
- 绑定 Core 能力：`C4-09`
- Control map 期望 Core 能力：`S4-X-04: C4-02, C4-09, C4-10`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-150-s4-x-04-c4-09-windows-repo-connect.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-150`
