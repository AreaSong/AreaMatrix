# Verify-ready Prompt: 4-1/task-16
...
- Phase：`phase-4`
- Task 标识：`4-1/task-16`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-16-c2-04-contract-api.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-16-c2-04-contract-api.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-16`
