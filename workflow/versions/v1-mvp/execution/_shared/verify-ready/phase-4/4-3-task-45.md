# Verify-ready Prompt: 4-3/task-45
...
- Phase：`phase-4`
- Task 标识：`4-3/task-45`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-45-c4-09-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-45`
- 依赖任务：`4-3/task-44`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S4-WIN-01-choose-repo, S4-X-04-repository-init-confirm, S4-X-05-repository-adopt-confirm`
- 绑定 Core 能力：`C4-09`
- Control map 期望 Core 能力：`S4-WIN-01: C4-09, C4-14; S4-X-04: C4-02, C4-09, C4-10; S4-X-05: C4-02, C4-09, C4-10`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-45-c4-09-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-45`
