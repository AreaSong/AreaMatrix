# Verify-ready Prompt: 4-1/task-127
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-127`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-127-s2-16-c2-12-classifier-correction.md`
...
- Manifest 章节：`## 4-1/task-127`
- 依赖任务：`4-1/task-126, 4-1/task-60`
- 风险等级：`High`
- 绑定 UX 页面：`S2-16-classifier-correct`
- 绑定 Core 能力：`C2-12`
- Control map 期望 Core 能力：`S2-16: C2-12`
- 当前 task 覆盖 Core 能力：`C2-12`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-127-s2-16-c2-12-classifier-correction.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-127`
