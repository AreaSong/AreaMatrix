# Verify-ready Prompt: 4-3/task-114
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-114`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-114-s4-ios-07-c4-06-files-import.md`
...
- Manifest 章节：`## 4-3/task-114`
- 依赖任务：`4-3/task-113, 4-3/task-30`
- 风险等级：`High`
- 绑定 UX 页面：`S4-IOS-07-files-import`
- 绑定 Core 能力：`C4-06`
- Control map 期望 Core 能力：`S4-IOS-07: C4-06, C4-21`
- 当前 task 覆盖 Core 能力：`C4-06`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-114-s4-ios-07-c4-06-files-import.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-114`
