# Verify-ready Prompt: 4-3/task-152
...
- Phase：`phase-4`
- Task 标识：`4-3/task-152`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-152-s4-x-04-page-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-152`
- 依赖任务：`4-3/task-149, 4-3/task-150, 4-3/task-151`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-152-s4-x-04-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-152`
