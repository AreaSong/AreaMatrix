# Verify-ready Prompt: 4-1/task-20
...
- Phase：`phase-4`
- Task 标识：`4-1/task-20`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-20-c2-04-integration-verify.md`
...
- Manifest 章节：`## 4-1/task-20`
- 依赖任务：`4-1/task-19`
- 风险等级：`High`
- 绑定 UX 页面：`S2-06-smart-lists, S2-15-command-palette`
- 绑定 Core 能力：`C2-04`
- Control map 期望 Core 能力：`S2-06: C2-03, C2-04; S2-15: C2-04, C2-11`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-20-c2-04-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-20`
