# Verify-ready Prompt: 4-3/task-162
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-162`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-162-s4-x-09-c4-16-sync-conflict-resolve.md`
...
- Manifest 章节：`## 4-3/task-162`
- 依赖任务：`4-3/task-161, 4-3/task-80`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-162-s4-x-09-c4-16-sync-conflict-resolve.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-162`
