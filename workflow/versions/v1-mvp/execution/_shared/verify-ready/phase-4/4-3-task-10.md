# Verify-ready Prompt: 4-3/task-10
...
- Phase：`phase-4`
- Task 标识：`4-3/task-10`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-10-c4-02-integration-verify.md`
...
- Manifest 章节：`## 4-3/task-10`
- 依赖任务：`4-3/task-09`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S4-IOS-01-connect-repo, S4-X-04-repository-init-confirm, S4-X-05-repository-adopt-confirm`
- 绑定 Core 能力：`C4-02`
- Control map 期望 Core 能力：`S4-IOS-01: C4-02, C4-08; S4-X-04: C4-02, C4-09, C4-10; S4-X-05: C4-02, C4-09, C4-10`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-10-c4-02-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-10`
