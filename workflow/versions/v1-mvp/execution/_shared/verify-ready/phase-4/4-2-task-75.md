# Verify-ready Prompt: 4-2/task-75
...
- Phase：`phase-4`
- Task 标识：`4-2/task-75`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-75-s3-10-c3-04-ai-classification-suggestion.md`
...
- Manifest 章节：`## 4-2/task-75`
- 依赖任务：`4-2/task-74, 4-2/task-20`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-75-s3-10-c3-04-ai-classification-suggestion.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-75`
