# Verify-ready Prompt: 4-3/task-112
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-3/task-112`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-112-s4-ios-05-c4-07-mobile-detail.md`
...
- Manifest 章节：`## 4-3/task-112`
- 依赖任务：`4-3/task-111, 4-3/task-35`
- 风险等级：`High`
- 绑定 UX 页面：`S4-IOS-05-mobile-file-detail`
- 绑定 Core 能力：`C4-07`
- Control map 期望 Core 能力：`S4-IOS-05: C4-07`
- 当前 task 覆盖 Core 能力：`C4-07`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-3-stage4-multiplatform/task-112-s4-ios-05-c4-07-mobile-detail.md`
...
9. 在 manifest 中定位章节：`## 4-3/task-112`
