# Verify-ready Prompt: 4-1/task-10
...
- Phase：`phase-4`
- Task 标识：`4-1/task-10`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-10-c2-02-integration-verify.md`
...
- Manifest 章节：`## 4-1/task-10`
- 依赖任务：`4-1/task-09`
- 风险等级：`High`
- 绑定 UX 页面：`S2-01-search-results, S2-02-search-filters, S2-08-tags-filter`
- 绑定 Core 能力：`C2-02`
- Control map 期望 Core 能力：`S2-01: C2-01, C2-02; S2-02: C2-02; S2-08: C2-02, C2-05`
- 当前 task 覆盖 Core 能力：`C2-02`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-10-c2-02-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-10`
