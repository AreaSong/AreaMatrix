# Verify-ready Prompt: 4-1/task-110
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-110`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-110-s2-09-c2-06-batch-add-tags.md`
...
- Manifest 章节：`## 4-1/task-110`
- 依赖任务：`4-1/task-109, 4-1/task-30`
- 风险等级：`High`
- 绑定 UX 页面：`S2-09-batch-add-tags`
- 绑定 Core 能力：`C2-06`
- Control map 期望 Core 能力：`S2-09: C2-06, C2-07`
- 当前 task 覆盖 Core 能力：`C2-06`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-110-s2-09-c2-06-batch-add-tags.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-110`
