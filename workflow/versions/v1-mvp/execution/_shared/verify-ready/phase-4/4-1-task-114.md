# Verify-ready Prompt: 4-1/task-114
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-114`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-114-s2-11-c2-07-undo-action-log.md`
...
- Manifest 章节：`## 4-1/task-114`
- 依赖任务：`4-1/task-113, 4-1/task-35`
- 风险等级：`High`
- 绑定 UX 页面：`S2-11-undo-history`
- 绑定 Core 能力：`C2-07`
- Control map 期望 Core 能力：`S2-11: C2-07`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-114-s2-11-c2-07-undo-action-log.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-114`
