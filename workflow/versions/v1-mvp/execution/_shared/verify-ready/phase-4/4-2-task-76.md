# Verify-ready Prompt: 4-2/task-76
...
- Phase：`phase-4`
- Task 标识：`4-2/task-76`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-76-s3-10-c3-08-semantic-search.md`
...
- Manifest 章节：`## 4-2/task-76`
- 依赖任务：`4-2/task-75, 4-2/task-40`
- 风险等级：`High`
- 绑定 UX 页面：`S3-10-ai-fallback`
- 绑定 Core 能力：`C3-08`
- Control map 期望 Core 能力：`S3-10: C3-04, C3-08, C3-10`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-2-stage3-ai/task-76-s3-10-c3-08-semantic-search.md`
...
9. 在 manifest 中定位章节：`## 4-2/task-76`
