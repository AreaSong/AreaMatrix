# Verify-ready Prompt: 4-1/task-128
...
- 任务细分：`page-feature`
- Phase：`phase-4`
- Task 标识：`4-1/task-128`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-128-s2-17-c2-13-classifier-rule-save.md`
...
- Manifest 章节：`## 4-1/task-128`
- 依赖任务：`4-1/task-127, 4-1/task-65`
- 风险等级：`High`
- 绑定 UX 页面：`S2-17-classifier-save-rule`
- 绑定 Core 能力：`C2-13`
- Control map 期望 Core 能力：`S2-17: C2-13`
- 当前 task 覆盖 Core 能力：`C2-13`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-128-s2-17-c2-13-classifier-rule-save.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-128`
