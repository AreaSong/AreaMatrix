# Verify-ready Prompt: 4-1/task-142
...
- Phase：`phase-4`
- Task 标识：`4-1/task-142`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-142-s2-23-page-integration-verify.md`
...
- Manifest 章节：`## 4-1/task-142`
- 依赖任务：`4-1/task-140, 4-1/task-141`
- 风险等级：`High`
- 绑定 UX 页面：`S2-23-tag-suggestions`
- 绑定 Core 能力：`C2-19, C2-05`
- Control map 期望 Core 能力：`S2-23: C2-19, C2-05`
- 当前 task 覆盖 Core 能力：`C2-05, C2-19`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-4/4-1-stage2-experience/task-142-s2-23-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 4-1/task-142`
