# Verify-ready Prompt: 3-1/task-04
...
- Phase：`phase-3`
- Task 标识：`3-1/task-04`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-3/3-1-stability-release/task-04-release-checklist.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-3/3-1-stability-release/task-04-release-checklist.md`
...
9. 在 manifest 中定位章节：`## 3-1/task-04`
