# Verify-ready Prompt: 3-1/task-05
...
- Phase：`phase-3`
- Task 标识：`3-1/task-05`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-3/3-1-stability-release/task-05-stage1-integration-verify.md`
...
- Phase Manifest：`./workflow/versions/v1-mvp/execution/_shared/manifests/phase-3.md`
- Manifest 章节：`## 3-1/task-05`
- 依赖任务：`3-1/task-04`
...
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `6` 个，现有代码 `3` 项，预期新增路径 `4` 项，禁止触碰路径 `4` 项，验证命令 `3` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-3/3-1-stability-release/task-05-stage1-integration-verify.md`
...
8. 读取 phase manifest：`./workflow/versions/v1-mvp/execution/_shared/manifests/phase-3.md`
9. 在 manifest 中定位章节：`## 3-1/task-05`
