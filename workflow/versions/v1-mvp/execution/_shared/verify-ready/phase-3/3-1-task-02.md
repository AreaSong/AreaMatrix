# Verify-ready Prompt: 3-1/task-02
...
- Phase：`phase-3`
- Task 标识：`3-1/task-02`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-3/3-1-stability-release/task-02-recovery-scenarios.md`
...
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `4` 个，现有代码 `3` 项，预期新增路径 `4` 项，禁止触碰路径 `0` 项，验证命令 `4` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-3/3-1-stability-release/task-02-recovery-scenarios.md`
...
9. 在 manifest 中定位章节：`## 3-1/task-02`
