# Verify-ready Prompt: 1-2/task-04
...
- Phase：`phase-1`
- Task 标识：`1-2/task-04`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-2-import-classify/task-04-c1-05-integration-verify.md`
...
- Manifest 章节：`## 1-2/task-04`
- 依赖任务：`1-2/task-03`
- 风险等级：`High`
- 绑定 UX 页面：`S1-16-drag-hover, S1-17-import-single-sheet, S1-18-import-batch-sheet, S1-19-import-folder-sheet, S1-28-settings-classifier`
- 绑定 Core 能力：`C1-05`
- Control map 期望 Core 能力：`S1-16: C1-05; S1-17: C1-05, C1-06, C1-07, C1-08; S1-18: C1-05, C1-06, C1-09; S1-19: C1-05, C1-06, C1-08; S1-28: C1-04, C1-05`
- 当前 task 覆盖 Core 能力：`C1-05`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-2-import-classify/task-04-c1-05-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-2/task-04`
