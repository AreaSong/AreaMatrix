# Verify-ready Prompt: 1-4/task-15
...
- Phase：`phase-1`
- Task 标识：`1-4/task-15`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-4-recovery-sync-overview/task-15-c1-18-integration-verify.md`
...
- Manifest 章节：`## 1-4/task-15`
- 依赖任务：`1-4/task-14`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S1-09-main-list, S1-13-detail-log`
- 绑定 Core 能力：`C1-18`
- Control map 期望 Core 能力：`S1-09: C1-11, C1-12, C1-15; S1-13: C1-13, C1-17, C1-18, C1-19`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-4-recovery-sync-overview/task-15-c1-18-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-4/task-15`
