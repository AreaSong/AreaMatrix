# Verify-ready Prompt: 1-4/task-25
...
- Phase：`phase-1`
- Task 标识：`1-4/task-25`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-4-recovery-sync-overview/task-25-c1-20-integration-verify.md`
...
- Manifest 章节：`## 1-4/task-25`
- 依赖任务：`1-4/task-24`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S1-27-settings-repository, S1-30-settings-advanced`
- 绑定 Core 能力：`C1-20`
- Control map 期望 Core 能力：`S1-27: C1-04, C1-08, C1-20; S1-30: C1-04, C1-16, C1-20`
- 当前 task 覆盖 Core 能力：`C1-20`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-4-recovery-sync-overview/task-25-c1-20-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-4/task-25`
