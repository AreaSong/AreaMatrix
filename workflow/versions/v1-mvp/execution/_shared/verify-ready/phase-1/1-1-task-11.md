# Verify-ready Prompt: 1-1/task-11
...
- Phase：`phase-1`
- Task 标识：`1-1/task-11`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-1-repo-config/task-11-c1-03-implementation.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-1-repo-config/task-11-c1-03-implementation.md`
...
9. 在 manifest 中定位章节：`## 1-1/task-11`
