# Verify-ready Prompt: 1-2/task-16
...
- Phase：`phase-1`
- Task 标识：`1-2/task-16`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-2-import-classify/task-16-c1-08-implementation.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-2-import-classify/task-16-c1-08-implementation.md`
...
9. 在 manifest 中定位章节：`## 1-2/task-16`
