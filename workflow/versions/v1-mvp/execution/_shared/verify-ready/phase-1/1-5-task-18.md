# Verify-ready Prompt: 1-5/task-18
...
- Phase：`phase-1`
- Task 标识：`1-5/task-18`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-18-c1-25-failure-recovery.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-18-c1-25-failure-recovery.md`
...
9. 在 manifest 中定位章节：`## 1-5/task-18`
