# Verify-ready Prompt: 1-1/task-19
...
- Phase：`phase-1`
- Task 标识：`1-1/task-19`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-1-repo-config/task-19-c1-04-integration-verify.md`
...
- Manifest 章节：`## 1-1/task-19`
- 依赖任务：`1-1/task-18`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S1-26-settings-general, S1-27-settings-repository, S1-28-settings-classifier, S1-30-settings-advanced`
- 绑定 Core 能力：`C1-04`
- Control map 期望 Core 能力：`S1-26: C1-04, C1-07; S1-27: C1-04, C1-08, C1-20; S1-28: C1-04, C1-05; S1-30: C1-04, C1-16, C1-20`
- 当前 task 覆盖 Core 能力：`C1-04`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-1-repo-config/task-19-c1-04-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-1/task-19`
