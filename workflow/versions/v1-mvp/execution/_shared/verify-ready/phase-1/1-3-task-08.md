# Verify-ready Prompt: 1-3/task-08
...
- Phase：`phase-1`
- Task 标识：`1-3/task-08`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-3-query-detail/task-08-c1-12-integration-verify.md`
...
- Manifest 章节：`## 1-3/task-08`
- 依赖任务：`1-3/task-07`
- 风险等级：`High`
- 绑定 UX 页面：`S1-12-detail-meta, S1-15-detail-multi`
- 绑定 Core 能力：`C1-12`
- Control map 期望 Core 能力：`S1-12: C1-12; S1-15: C1-11, C1-12`
- 当前 task 覆盖 Core 能力：`C1-12`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-3-query-detail/task-08-c1-12-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-3/task-08`
