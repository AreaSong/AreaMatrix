# Verify-ready Prompt: 1-2/task-24
...
- Phase：`phase-1`
- Task 标识：`1-2/task-24`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-2-import-classify/task-24-c1-09-integration-verify.md`
...
- Manifest 章节：`## 1-2/task-24`
- 依赖任务：`1-2/task-23`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S1-22-conflict-duplicate, S1-24-replace-confirm`
- 绑定 Core 能力：`C1-09`
- Control map 期望 Core 能力：`S1-22: C1-09; S1-24: C1-09, C1-10`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-2-import-classify/task-24-c1-09-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-2/task-24`
