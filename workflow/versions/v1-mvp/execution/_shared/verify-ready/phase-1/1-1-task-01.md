# Verify-ready Prompt: 1-1/task-01
...
- Phase：`phase-1`
- Task 标识：`1-1/task-01`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-1-repo-config/task-01-c1-01-contract-api.md`
...
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `4` 个，现有代码 `2` 项，预期新增路径 `4` 项，禁止触碰路径 `1` 项，验证命令 `3` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-1-repo-config/task-01-c1-01-contract-api.md`
...
9. 在 manifest 中定位章节：`## 1-1/task-01`
