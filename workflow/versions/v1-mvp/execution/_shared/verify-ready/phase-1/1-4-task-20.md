# Verify-ready Prompt: 1-4/task-20
...
- Phase：`phase-1`
- Task 标识：`1-4/task-20`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-4-recovery-sync-overview/task-20-c1-19-integration-verify.md`
...
- Manifest 章节：`## 1-4/task-20`
- 依赖任务：`1-4/task-19`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S1-09-main-list, S1-11-main-repo-error, S1-13-detail-log`
- 绑定 Core 能力：`C1-19`
- Control map 期望 Core 能力：`S1-09: C1-11, C1-12, C1-15; S1-11: C1-01, C1-19, C1-21; S1-13: C1-13, C1-17, C1-18, C1-19`
- 当前 task 覆盖 Core 能力：`C1-19`
- Secondary capability 状态：`消费页面中的其他能力不属于当前 Core task 验收范围；仅检查当前能力是否满足这些页面对该能力的需求`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `6` 个，现有代码 `2` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `3` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-4-recovery-sync-overview/task-20-c1-19-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-4/task-20`
