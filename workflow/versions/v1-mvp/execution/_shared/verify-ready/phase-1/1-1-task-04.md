# Verify-ready Prompt: 1-1/task-04
...
- Phase：`phase-1`
- Task 标识：`1-1/task-04`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-1-repo-config/task-04-c1-01-integration-verify.md`
...
- Manifest 章节：`## 1-1/task-04`
- 依赖任务：`1-1/task-03`
- 风险等级：`High`
- 绑定 UX 页面：`S1-02-choose-path, S1-03-validate-path, S1-11-main-repo-error, S1-32-error-recovery`
- 绑定 Core 能力：`C1-01`
- Control map 期望 Core 能力：`S1-02: C1-01; S1-03: C1-01, C1-03, C1-21; S1-11: C1-01, C1-19, C1-21; S1-32: C1-16, C1-21`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-1-repo-config/task-04-c1-01-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-1/task-04`
