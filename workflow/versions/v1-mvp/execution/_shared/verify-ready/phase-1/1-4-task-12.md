# Verify-ready Prompt: 1-4/task-12
...
- Phase：`phase-1`
- Task 标识：`1-4/task-12`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-4-recovery-sync-overview/task-12-c1-18-implementation.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-4-recovery-sync-overview/task-12-c1-18-implementation.md`
...
9. 在 manifest 中定位章节：`## 1-4/task-12`
