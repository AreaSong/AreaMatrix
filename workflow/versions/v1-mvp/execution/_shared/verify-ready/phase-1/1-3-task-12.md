# Verify-ready Prompt: 1-3/task-12
...
- Phase：`phase-1`
- Task 标识：`1-3/task-12`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-3-query-detail/task-12-c1-13-integration-verify.md`
...
- Manifest 章节：`## 1-3/task-12`
- 依赖任务：`1-3/task-11`
- 风险等级：`High`
- 绑定 UX 页面：`S1-13-detail-log, S1-21-import-result, S1-32-error-recovery`
- 绑定 Core 能力：`C1-13`
- Control map 期望 Core 能力：`S1-13: C1-13, C1-17, C1-18, C1-19; S1-21: C1-06, C1-13; S1-32: C1-16, C1-21`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-3-query-detail/task-12-c1-13-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-3/task-12`
