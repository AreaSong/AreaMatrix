# Verify-ready Prompt: 1-5/task-05
...
- Phase：`phase-1`
- Task 标识：`1-5/task-05`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-05-c1-22-integration-verify.md`
...
- Manifest 章节：`## 1-5/task-05`
- 依赖任务：`1-5/task-04`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S1-33-file-rename-sheet`
- 绑定 Core 能力：`C1-22`
- Control map 期望 Core 能力：`S1-33: C1-22`
- 当前 task 覆盖 Core 能力：`C1-22`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-05-c1-22-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-5/task-05`
