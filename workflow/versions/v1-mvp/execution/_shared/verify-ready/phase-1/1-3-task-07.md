# Verify-ready Prompt: 1-3/task-07
...
- Phase：`phase-1`
- Task 标识：`1-3/task-07`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-3-query-detail/task-07-c1-12-validation.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-3-query-detail/task-07-c1-12-validation.md`
...
9. 在 manifest 中定位章节：`## 1-3/task-07`
