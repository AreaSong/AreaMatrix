# Verify-ready Prompt: 1-5/task-20
...
- Phase：`phase-1`
- Task 标识：`1-5/task-20`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-20-c1-25-integration-verify.md`
...
- Manifest 章节：`## 1-5/task-20`
- 依赖任务：`1-5/task-19`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S1-36-icloud-conflict-list, S1-25-icloud-conflict-min`
- 绑定 Core 能力：`C1-25`
- Control map 期望 Core 能力：`S1-36: C1-25; S1-25: C1-01, C1-21`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-20-c1-25-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-5/task-20`
