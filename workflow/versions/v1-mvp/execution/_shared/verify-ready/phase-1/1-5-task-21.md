# Verify-ready Prompt: 1-5/task-21
...
- Phase：`phase-1`
- Task 标识：`1-5/task-21`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-21-c1-26-contract-api.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-21-c1-26-contract-api.md`
...
9. 在 manifest 中定位章节：`## 1-5/task-21`
