# Verify-ready Prompt: 1-2/task-23
...
- Phase：`phase-1`
- Task 标识：`1-2/task-23`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-2-import-classify/task-23-c1-09-validation.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-2-import-classify/task-23-c1-09-validation.md`
...
9. 在 manifest 中定位章节：`## 1-2/task-23`
