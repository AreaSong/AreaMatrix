# Verify-ready Prompt: 1-1/task-18
...
- Phase：`phase-1`
- Task 标识：`1-1/task-18`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-1-repo-config/task-18-c1-04-validation.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-1-repo-config/task-18-c1-04-validation.md`
...
9. 在 manifest 中定位章节：`## 1-1/task-18`
