# Verify-ready Prompt: 1-4/task-05
...
- Phase：`phase-1`
- Task 标识：`1-4/task-05`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-4-recovery-sync-overview/task-05-c1-16-integration-verify.md`
...
- Manifest 章节：`## 1-4/task-05`
- 依赖任务：`1-4/task-04`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S1-05-initializing, S1-10-main-loading, S1-32-error-recovery`
- 绑定 Core 能力：`C1-16`
- Control map 期望 Core 能力：`S1-05: C1-02, C1-03, C1-16; S1-10: C1-03, C1-15, C1-16; S1-32: C1-16, C1-21`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-4-recovery-sync-overview/task-05-c1-16-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-4/task-05`
