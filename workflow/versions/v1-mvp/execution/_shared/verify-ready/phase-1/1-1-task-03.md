# Verify-ready Prompt: 1-1/task-03
...
- Phase：`phase-1`
- Task 标识：`1-1/task-03`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-1-repo-config/task-03-c1-01-validation.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-1-repo-config/task-03-c1-01-validation.md`
...
9. 在 manifest 中定位章节：`## 1-1/task-03`
