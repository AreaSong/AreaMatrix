# Verify-ready Prompt: 1-5/task-25
...
- Phase：`phase-1`
- Task 标识：`1-5/task-25`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-25-c1-26-integration-verify.md`
...
- Manifest 章节：`## 1-5/task-25`
- 依赖任务：`1-5/task-24`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S1-37-db-repair-confirm, S1-11-main-repo-error, S1-32-error-recovery`
- 绑定 Core 能力：`C1-26`
- Control map 期望 Core 能力：`S1-37: C1-26, C1-16; S1-11: C1-01, C1-19, C1-21; S1-32: C1-16, C1-21`
- 当前 task 覆盖 Core 能力：`C1-26`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-25-c1-26-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-5/task-25`
