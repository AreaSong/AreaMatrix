# Verify-ready Prompt: 1-3/task-01
...
- Phase：`phase-1`
- Task 标识：`1-3/task-01`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-3-query-detail/task-01-c1-11-contract-api.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-3-query-detail/task-01-c1-11-contract-api.md`
...
9. 在 manifest 中定位章节：`## 1-3/task-01`
