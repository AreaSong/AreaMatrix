# Verify-ready Prompt: 1-5/task-10
...
- Phase：`phase-1`
- Task 标识：`1-5/task-10`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-10-c1-23-integration-verify.md`
...
- Manifest 章节：`## 1-5/task-10`
- 依赖任务：`1-5/task-09`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S1-34-file-delete-confirm`
- 绑定 Core 能力：`C1-23`
- Control map 期望 Core 能力：`S1-34: C1-23`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-10-c1-23-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-5/task-10`
