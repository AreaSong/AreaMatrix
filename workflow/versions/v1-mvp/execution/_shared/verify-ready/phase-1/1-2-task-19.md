# Verify-ready Prompt: 1-2/task-19
...
- Phase：`phase-1`
- Task 标识：`1-2/task-19`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-2-import-classify/task-19-c1-08-integration-verify.md`
...
- Manifest 章节：`## 1-2/task-19`
- 依赖任务：`1-2/task-18`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S1-17-import-single-sheet, S1-20-import-progress, S1-21-import-result, S1-27-settings-repository`
- 绑定 Core 能力：`C1-08`
- Control map 期望 Core 能力：`S1-17: C1-05, C1-06, C1-07, C1-08; S1-20: C1-06, C1-07, C1-08; S1-21: C1-06, C1-13; S1-27: C1-04, C1-08, C1-20`
- 当前 task 覆盖 Core 能力：`C1-08`
- Secondary capability 状态：`消费页面中的其他能力不属于当前 Core task 验收范围；仅检查当前能力是否满足这些页面对该能力的需求`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `7` 个，现有代码 `2` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `3` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-2-import-classify/task-19-c1-08-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-2/task-19`
