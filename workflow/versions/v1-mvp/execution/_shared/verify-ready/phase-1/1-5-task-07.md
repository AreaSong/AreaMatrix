# Verify-ready Prompt: 1-5/task-07
...
- 类型：单任务验收
- 任务类型：`atomic`
- 任务细分：`core-implementation`
- Phase：`phase-1`
- Task 标识：`1-5/task-07`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-07-c1-23-implementation.md`
...
- Manifest 章节：`## 1-5/task-07`
- 依赖任务：`1-5/task-06`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`None`
- 绑定 Core 能力：`C1-23`
- Control map 期望 Core 能力：`None`
- 当前 task 覆盖 Core 能力：`C1-23`
- Secondary capability 状态：`None`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `4` 个，现有代码 `2` 项，预期新增路径 `6` 项，禁止触碰路径 `1` 项，验证命令 `3` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-5-file-actions-repair/task-07-c1-23-implementation.md`
...
9. 在 manifest 中定位章节：`## 1-5/task-07`
