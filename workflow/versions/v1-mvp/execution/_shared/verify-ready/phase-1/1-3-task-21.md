# Verify-ready Prompt: 1-3/task-21
...
- Phase：`phase-1`
- Task 标识：`1-3/task-21`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-3-query-detail/task-21-c1-15-integration-verify.md`
...
- Manifest 章节：`## 1-3/task-21`
- 依赖任务：`1-3/task-20`
- 风险等级：`High`
- 绑定 UX 页面：`S1-08-main-empty, S1-09-main-list, S1-10-main-loading`
- 绑定 Core 能力：`C1-15`
- Control map 期望 Core 能力：`S1-08: C1-11, C1-15; S1-09: C1-11, C1-12, C1-15; S1-10: C1-03, C1-15, C1-16`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-3-query-detail/task-21-c1-15-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-3/task-21`
