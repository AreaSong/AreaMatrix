# Verify-ready Prompt: 1-2/task-09
...
- Phase：`phase-1`
- Task 标识：`1-2/task-09`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-2-import-classify/task-09-c1-06-integration-verify.md`
...
- Manifest 章节：`## 1-2/task-09`
- 依赖任务：`1-2/task-08`
- 风险等级：`Mission-Critical`
- 绑定 UX 页面：`S1-17-import-single-sheet, S1-20-import-progress, S1-21-import-result, S1-09-main-list`
- 绑定 Core 能力：`C1-06`
- Control map 期望 Core 能力：`S1-17: C1-05, C1-06, C1-07, C1-08; S1-20: C1-06, C1-07, C1-08; S1-21: C1-06, C1-13; S1-09: C1-11, C1-12, C1-15`
- 当前 task 覆盖 Core 能力：`C1-06`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-1/1-2-import-classify/task-09-c1-06-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 1-2/task-09`
