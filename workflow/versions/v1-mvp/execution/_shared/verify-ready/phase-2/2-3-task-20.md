# Verify-ready Prompt: 2-3/task-20
...
- Phase：`phase-2`
- Task 标识：`2-3/task-20`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-20-s1-28-c1-05-classify-preview.md`
...
- Manifest 章节：`## 2-3/task-20`
- 依赖任务：`2-3/task-19, 1-2/task-04`
- 风险等级：`High`
- 绑定 UX 页面：`S1-28-settings-classifier`
- 绑定 Core 能力：`C1-05`
- Control map 期望 Core 能力：`S1-28: C1-04, C1-05`
- 当前 task 覆盖 Core 能力：`C1-05`
- Secondary capability 状态：`C1-04（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-20-s1-28-c1-05-classify-preview.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-20`
