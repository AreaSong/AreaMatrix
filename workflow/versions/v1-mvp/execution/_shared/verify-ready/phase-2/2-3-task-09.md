# Verify-ready Prompt: 2-3/task-09
...
- Phase：`phase-2`
- Task 标识：`2-3/task-09`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-09-s1-15-c1-12-get-file-detail.md`
...
- Manifest 章节：`## 2-3/task-09`
- 依赖任务：`2-3/task-08, 1-3/task-08`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-09-s1-15-c1-12-get-file-detail.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-09`
