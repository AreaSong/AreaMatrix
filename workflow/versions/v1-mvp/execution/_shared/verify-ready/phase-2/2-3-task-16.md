# Verify-ready Prompt: 2-3/task-16
...
- Phase：`phase-2`
- Task 标识：`2-3/task-16`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-16-s1-27-c1-08-import-index-file.md`
...
- Manifest 章节：`## 2-3/task-16`
- 依赖任务：`2-3/task-15, 1-2/task-19`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-16-s1-27-c1-08-import-index-file.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-16`
