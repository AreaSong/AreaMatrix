# Verify-ready Prompt: 2-1/task-06
...
- Phase：`phase-2`
- Task 标识：`2-1/task-06`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-06-s1-03-page-integration-verify.md`
...
- Manifest 章节：`## 2-1/task-06`
- 依赖任务：`2-1/task-03, 2-1/task-04, 2-1/task-05`
- 风险等级：`High`
- 绑定 UX 页面：`S1-03-validate-path`
- 绑定 Core 能力：`C1-01, C1-03, C1-21`
- Control map 期望 Core 能力：`S1-03: C1-01, C1-03, C1-21`
- 当前 task 覆盖 Core 能力：`C1-01, C1-03, C1-21`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-06-s1-03-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-06`
