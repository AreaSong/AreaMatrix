# Verify-ready Prompt: 2-1/task-11
...
- Phase：`phase-2`
- Task 标识：`2-1/task-11`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-11-s1-05-c1-03-adopt-existing-repo.md`
...
- Manifest 章节：`## 2-1/task-11`
- 依赖任务：`2-1/task-10, 1-1/task-14`
- 风险等级：`High`
- 绑定 UX 页面：`S1-05-initializing`
- 绑定 Core 能力：`C1-03`
- Control map 期望 Core 能力：`S1-05: C1-02, C1-03, C1-16`
- 当前 task 覆盖 Core 能力：`C1-03`
- Secondary capability 状态：`C1-02, C1-16（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `4` 个，现有代码 `3` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-11-s1-05-c1-03-adopt-existing-repo.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-11`
