# Verify-ready Prompt: 2-1/task-34
...
- Phase：`phase-2`
- Task 标识：`2-1/task-34`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-34-main-window-integration-verify.md`
...
- Manifest 章节：`## 2-1/task-34`
- 依赖任务：`2-1/task-33`
- 风险等级：`High`
- 绑定 UX 页面：`S1-08-main-empty, S1-09-main-list, S1-10-main-loading, S1-11-main-repo-error`
- 绑定 Core 能力：`C1-11, C1-15, C1-12, C1-03, C1-16, C1-01, C1-19, C1-21`
- Control map 期望 Core 能力：`S1-08: C1-11, C1-15; S1-09: C1-11, C1-12, C1-15; S1-10: C1-03, C1-15, C1-16; S1-11: C1-01, C1-19, C1-21`
- 当前 task 覆盖 Core 能力：`C1-01, C1-03, C1-11, C1-12, C1-15, C1-16, C1-19, C1-21`
- Secondary capability 状态：`None`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `14` 个，现有代码 `2` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-34-main-window-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-34`
