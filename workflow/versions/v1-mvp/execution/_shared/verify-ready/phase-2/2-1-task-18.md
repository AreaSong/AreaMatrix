# Verify-ready Prompt: 2-1/task-18
...
- Phase：`phase-2`
- Task 标识：`2-1/task-18`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-18-first-launch-integration-verify.md`
...
- Manifest 章节：`## 2-1/task-18`
- 依赖任务：`2-1/task-17`
- 风险等级：`High`
- 绑定 UX 页面：`S1-01-welcome, S1-02-choose-path, S1-03-validate-path, S1-04-confirm-init, S1-05-initializing, S1-06-init-failed, S1-07-init-done`
- 绑定 Core 能力：`C1-04, C1-01, C1-03, C1-21, C1-02, C1-16`
- Control map 期望 Core 能力：`S1-01: C1-04; S1-02: C1-01; S1-03: C1-01, C1-03, C1-21; S1-04: C1-02, C1-03; S1-05: C1-02, C1-03, C1-16; S1-06: C1-21; S1-07: C1-02, C1-03`
- 当前 task 覆盖 Core 能力：`C1-01, C1-02, C1-03, C1-04, C1-16, C1-21`
- Secondary capability 状态：`None`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `15` 个，现有代码 `2` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-18-first-launch-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-18`
