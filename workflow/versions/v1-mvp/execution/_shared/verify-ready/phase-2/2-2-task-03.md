# Verify-ready Prompt: 2-2/task-03
...
- Phase：`phase-2`
- Task 标识：`2-2/task-03`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-03-s1-17-c1-06-import-copy-file.md`
...
- Manifest 章节：`## 2-2/task-03`
- 依赖任务：`2-2/task-02, 1-2/task-09`
- 风险等级：`High`
- 绑定 UX 页面：`S1-17-import-single-sheet`
- 绑定 Core 能力：`C1-06`
- Control map 期望 Core 能力：`S1-17: C1-05, C1-06, C1-07, C1-08`
- 当前 task 覆盖 Core 能力：`C1-06`
- Secondary capability 状态：`C1-05, C1-07, C1-08（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-03-s1-17-c1-06-import-copy-file.md`
...
9. 在 manifest 中定位章节：`## 2-2/task-03`
