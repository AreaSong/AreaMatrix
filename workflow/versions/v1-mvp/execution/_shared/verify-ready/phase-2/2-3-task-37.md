# Verify-ready Prompt: 2-3/task-37
...
- Phase：`phase-2`
- Task 标识：`2-3/task-37`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-37-file-actions-integration-verify.md`
...
- Manifest 章节：`## 2-3/task-37`
- 依赖任务：`2-3/task-36`
- 风险等级：`High`
- 绑定 UX 页面：`S1-33-file-rename-sheet, S1-34-file-delete-confirm, S1-35-change-category-sheet`
- 绑定 Core 能力：`C1-22, C1-23, C1-24, C1-10`
- Control map 期望 Core 能力：`S1-33: C1-22; S1-34: C1-23; S1-35: C1-24, C1-10`
- 当前 task 覆盖 Core 能力：`C1-10, C1-22, C1-23, C1-24`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-37-file-actions-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-37`
