# Verify-ready Prompt: 2-1/task-19
...
- Phase：`phase-2`
- Task 标识：`2-1/task-19`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-19-s1-08-c1-11-list-files.md`
...
- Manifest 章节：`## 2-1/task-19`
- 依赖任务：`2-1/task-18, 1-3/task-04`
- 风险等级：`High`
- 绑定 UX 页面：`S1-08-main-empty`
- 绑定 Core 能力：`C1-11`
- Control map 期望 Core 能力：`S1-08: C1-11, C1-15`
- 当前 task 覆盖 Core 能力：`C1-11`
- Secondary capability 状态：`C1-15（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-19-s1-08-c1-11-list-files.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-19`
