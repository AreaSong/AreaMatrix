# Verify-ready Prompt: 2-2/task-27
...
- Phase：`phase-2`
- Task 标识：`2-2/task-27`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-27-import-conflict-integration-verify.md`
...
- Phase Manifest：`./workflow/versions/v1-mvp/execution/_shared/manifests/phase-2.md`
- Manifest 章节：`## 2-2/task-27`
- 依赖任务：`2-2/task-26`
- 风险等级：`High`
- 绑定 UX 页面：`S1-16-drag-hover, S1-17-import-single-sheet, S1-18-import-batch-sheet, S1-19-import-folder-sheet, S1-20-import-progress, S1-21-import-result, S1-22-conflict-duplicate, S1-23-conflict-name, S1-24-replace-confirm`
- 绑定 Core 能力：`C1-05, C1-06, C1-07, C1-08, C1-09, C1-13, C1-10`
- Control map 期望 Core 能力：`S1-16: C1-05; S1-17: C1-05, C1-06, C1-07, C1-08; S1-18: C1-05, C1-06, C1-09; S1-19: C1-05, C1-06, C1-08; S1-20: C1-06, C1-07, C1-08; S1-21: C1-06, C1-13; S1-22: C1-09; S1-23: C1-10; S1-24: C1-09, C1-10`
- 当前 task 覆盖 Core 能力：`C1-05, C1-06, C1-07, C1-08, C1-09, C1-10, C1-13`
- Secondary capability 状态：`None`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `18` 个，现有代码 `2` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-27-import-conflict-integration-verify.md`
...
8. 读取 phase manifest：`./workflow/versions/v1-mvp/execution/_shared/manifests/phase-2.md`
9. 在 manifest 中定位章节：`## 2-2/task-27`
