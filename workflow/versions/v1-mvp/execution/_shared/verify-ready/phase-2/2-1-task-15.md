# Verify-ready Prompt: 2-1/task-15
...
- Phase：`phase-2`
- Task 标识：`2-1/task-15`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-15-s1-07-c1-02-init-empty-repo.md`
...
- Manifest 章节：`## 2-1/task-15`
- 依赖任务：`2-1/task-14, 1-1/task-09`
- 风险等级：`High`
- 绑定 UX 页面：`S1-07-init-done`
- 绑定 Core 能力：`C1-02`
- Control map 期望 Core 能力：`S1-07: C1-02, C1-03`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-15-s1-07-c1-02-init-empty-repo.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-15`
