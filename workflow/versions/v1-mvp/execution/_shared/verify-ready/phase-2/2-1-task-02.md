# Verify-ready Prompt: 2-1/task-02
...
- Phase：`phase-2`
- Task 标识：`2-1/task-02`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-02-s1-02-c1-01-validate-repo-path.md`
...
- Manifest 章节：`## 2-1/task-02`
- 依赖任务：`2-1/task-01, 1-1/task-04`
- 风险等级：`High`
- 绑定 UX 页面：`S1-02-choose-path`
- 绑定 Core 能力：`C1-01`
- Control map 期望 Core 能力：`S1-02: C1-01`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-02-s1-02-c1-01-validate-repo-path.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-02`
