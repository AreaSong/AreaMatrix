# Verify-ready Prompt: 2-4/task-06
...
- Phase：`phase-2`
- Task 标识：`2-4/task-06`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-4-sync-overview/task-06-s1-37-c1-16-recover-on-startup.md`
...
- Manifest 章节：`## 2-4/task-06`
- 依赖任务：`2-4/task-05, 1-4/task-05`
- 风险等级：`High`
- 绑定 UX 页面：`S1-37-db-repair-confirm`
- 绑定 Core 能力：`C1-16`
- Control map 期望 Core 能力：`S1-37: C1-26, C1-16`
- 当前 task 覆盖 Core 能力：`C1-16`
- Secondary capability 状态：`C1-26（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-4-sync-overview/task-06-s1-37-c1-16-recover-on-startup.md`
...
9. 在 manifest 中定位章节：`## 2-4/task-06`
