# Verify-ready Prompt: 2-3/task-27
...
- Phase：`phase-2`
- Task 标识：`2-3/task-27`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-27-s1-31-ui-only.md`
...
- Manifest 章节：`## 2-3/task-27`
- 依赖任务：`2-3/task-26`
- 风险等级：`High`
- 绑定 UX 页面：`S1-31-settings-about`
- 绑定 Core 能力：`None`
- Control map 期望 Core 能力：`S1-31: None`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-27-s1-31-ui-only.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-27`
