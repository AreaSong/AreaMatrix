# Verify-ready Prompt: 2-3/task-04
...
- Phase：`phase-2`
- Task 标识：`2-3/task-04`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-04-s1-13-c1-18-sync-external-renamed.md`
...
- Manifest 章节：`## 2-3/task-04`
- 依赖任务：`2-3/task-03, 1-4/task-15`
- 风险等级：`High`
- 绑定 UX 页面：`S1-13-detail-log`
- 绑定 Core 能力：`C1-18`
- Control map 期望 Core 能力：`S1-13: C1-13, C1-17, C1-18, C1-19`
- 当前 task 覆盖 Core 能力：`C1-18`
- Secondary capability 状态：`C1-13, C1-17, C1-19（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-04-s1-13-c1-18-sync-external-renamed.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-04`
