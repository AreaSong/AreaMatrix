# Verify-ready Prompt: 2-3/task-34
...
- Phase：`phase-2`
- Task 标识：`2-3/task-34`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-34-s1-35-c1-24-move-to-category.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-34-s1-35-c1-24-move-to-category.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-34`
