# Verify-ready Prompt: 2-1/task-26
...
- Phase：`phase-2`
- Task 标识：`2-1/task-26`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-26-s1-10-c1-03-adopt-existing-repo.md`
...
- Manifest 章节：`## 2-1/task-26`
- 依赖任务：`2-1/task-25, 1-1/task-14`
- 风险等级：`High`
- 绑定 UX 页面：`S1-10-main-loading`
- 绑定 Core 能力：`C1-03`
- Control map 期望 Core 能力：`S1-10: C1-03, C1-15, C1-16`
- 当前 task 覆盖 Core 能力：`C1-03`
- Secondary capability 状态：`C1-15, C1-16（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-26-s1-10-c1-03-adopt-existing-repo.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-26`
