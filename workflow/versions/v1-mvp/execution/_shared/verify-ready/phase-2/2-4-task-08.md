# Verify-ready Prompt: 2-4/task-08
...
- Phase：`phase-2`
- Task 标识：`2-4/task-08`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-4-sync-overview/task-08-sync-overview-repair-integration-verify.md`
...
- Manifest 章节：`## 2-4/task-08`
- 依赖任务：`2-4/task-07`
- 风险等级：`High`
- 绑定 UX 页面：`S1-25-icloud-conflict-min, S1-36-icloud-conflict-list, S1-37-db-repair-confirm`
- 绑定 Core 能力：`C1-01, C1-21, C1-25, C1-26, C1-16`
- Control map 期望 Core 能力：`S1-25: C1-01, C1-21; S1-36: C1-25; S1-37: C1-26, C1-16`
- 当前 task 覆盖 Core 能力：`C1-01, C1-16, C1-21, C1-25, C1-26`
- Secondary capability 状态：`None`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `10` 个，现有代码 `2` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-4-sync-overview/task-08-sync-overview-repair-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-4/task-08`
