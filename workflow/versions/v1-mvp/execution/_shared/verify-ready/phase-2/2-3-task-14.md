# Verify-ready Prompt: 2-3/task-14
...
- Phase：`phase-2`
- Task 标识：`2-3/task-14`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-14-s1-26-page-integration-verify.md`
...
- Manifest 章节：`## 2-3/task-14`
- 依赖任务：`2-3/task-12, 2-3/task-13`
- 风险等级：`High`
- 绑定 UX 页面：`S1-26-settings-general`
- 绑定 Core 能力：`C1-04, C1-07`
- Control map 期望 Core 能力：`S1-26: C1-04, C1-07`
- 当前 task 覆盖 Core 能力：`C1-04, C1-07`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-14-s1-26-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-14`
