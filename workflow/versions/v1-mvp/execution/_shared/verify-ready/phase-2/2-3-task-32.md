# Verify-ready Prompt: 2-3/task-32
...
- Phase：`phase-2`
- Task 标识：`2-3/task-32`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-32-s1-33-c1-22-rename-file.md`
...
- Manifest 章节：`## 2-3/task-32`
- 依赖任务：`2-3/task-31, 1-5/task-05`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-32-s1-33-c1-22-rename-file.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-32`
