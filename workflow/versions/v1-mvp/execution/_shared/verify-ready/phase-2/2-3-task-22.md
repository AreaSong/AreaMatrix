# Verify-ready Prompt: 2-3/task-22
...
- Phase：`phase-2`
- Task 标识：`2-3/task-22`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-22-s1-29-c1-04-load-update-config.md`
...
- Manifest 章节：`## 2-3/task-22`
- 依赖任务：`2-3/task-21, 1-1/task-19`
- 风险等级：`High`
- 绑定 UX 页面：`S1-29-settings-integrations`
- 绑定 Core 能力：`C1-04`
- Control map 期望 Core 能力：`S1-29: C1-04`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-22-s1-29-c1-04-load-update-config.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-22`
