# Verify-ready Prompt: 2-3/task-10
...
- Phase：`phase-2`
- Task 标识：`2-3/task-10`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-10-s1-15-page-integration-verify.md`
...
- Manifest 章节：`## 2-3/task-10`
- 依赖任务：`2-3/task-08, 2-3/task-09`
- 风险等级：`High`
- 绑定 UX 页面：`S1-15-detail-multi`
- 绑定 Core 能力：`C1-11, C1-12`
- Control map 期望 Core 能力：`S1-15: C1-11, C1-12`
- 当前 task 覆盖 Core 能力：`C1-11, C1-12`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-10-s1-15-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-10`
