# Verify-ready Prompt: 2-1/task-16
...
- Phase：`phase-2`
- Task 标识：`2-1/task-16`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-16-s1-07-c1-03-adopt-existing-repo.md`
...
- Manifest 章节：`## 2-1/task-16`
- 依赖任务：`2-1/task-15, 1-1/task-14`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-16-s1-07-c1-03-adopt-existing-repo.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-16`
