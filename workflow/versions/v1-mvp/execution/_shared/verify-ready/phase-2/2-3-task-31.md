# Verify-ready Prompt: 2-3/task-31
...
- Phase：`phase-2`
- Task 标识：`2-3/task-31`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-31-settings-error-recovery-integration-verify.md`
...
- Manifest 章节：`## 2-3/task-31`
- 依赖任务：`2-3/task-30`
- 风险等级：`High`
- 绑定 UX 页面：`S1-26-settings-general, S1-27-settings-repository, S1-28-settings-classifier, S1-29-settings-integrations, S1-30-settings-advanced, S1-31-settings-about, S1-32-error-recovery`
- 绑定 Core 能力：`C1-04, C1-07, C1-08, C1-20, C1-05, C1-16, C1-21`
- Control map 期望 Core 能力：`S1-26: C1-04, C1-07; S1-27: C1-04, C1-08, C1-20; S1-28: C1-04, C1-05; S1-29: C1-04; S1-30: C1-04, C1-16, C1-20; S1-31: None; S1-32: C1-16, C1-21`
- 当前 task 覆盖 Core 能力：`C1-04, C1-05, C1-07, C1-08, C1-16, C1-20, C1-21`
- Secondary capability 状态：`None`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `16` 个，现有代码 `2` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-31-settings-error-recovery-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-31`
