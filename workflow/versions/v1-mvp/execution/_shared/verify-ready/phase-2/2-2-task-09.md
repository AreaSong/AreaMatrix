# Verify-ready Prompt: 2-2/task-09
...
- Phase：`phase-2`
- Task 标识：`2-2/task-09`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-09-s1-18-c1-09-detect-duplicate.md`
...
- Manifest 章节：`## 2-2/task-09`
- 依赖任务：`2-2/task-08, 1-2/task-24`
- 风险等级：`High`
- 绑定 UX 页面：`S1-18-import-batch-sheet`
- 绑定 Core 能力：`C1-09`
- Control map 期望 Core 能力：`S1-18: C1-05, C1-06, C1-09`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-09-s1-18-c1-09-detect-duplicate.md`
...
9. 在 manifest 中定位章节：`## 2-2/task-09`
