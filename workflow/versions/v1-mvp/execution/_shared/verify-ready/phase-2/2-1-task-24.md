# Verify-ready Prompt: 2-1/task-24
...
- Phase：`phase-2`
- Task 标识：`2-1/task-24`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-24-s1-09-c1-15-build-tree.md`
...
- Manifest 章节：`## 2-1/task-24`
- 依赖任务：`2-1/task-23, 1-3/task-21`
- 风险等级：`High`
- 绑定 UX 页面：`S1-09-main-list`
- 绑定 Core 能力：`C1-15`
- Control map 期望 Core 能力：`S1-09: C1-11, C1-12, C1-15`
- 当前 task 覆盖 Core 能力：`C1-15`
- Secondary capability 状态：`C1-11, C1-12（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-24-s1-09-c1-15-build-tree.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-24`
