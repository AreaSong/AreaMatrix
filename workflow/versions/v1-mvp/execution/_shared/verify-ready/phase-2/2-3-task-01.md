# Verify-ready Prompt: 2-3/task-01
...
- Phase：`phase-2`
- Task 标识：`2-3/task-01`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-01-s1-12-c1-12-get-file-detail.md`
...
- Manifest 章节：`## 2-3/task-01`
- 依赖任务：`2-2/task-27, 1-3/task-08`
- 风险等级：`High`
- 绑定 UX 页面：`S1-12-detail-meta`
- 绑定 Core 能力：`C1-12`
- Control map 期望 Core 能力：`S1-12: C1-12`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-01-s1-12-c1-12-get-file-detail.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-01`
