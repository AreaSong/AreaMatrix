# Verify-ready Prompt: 2-1/task-31
...
- Phase：`phase-2`
- Task 标识：`2-1/task-31`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-31-s1-11-c1-19-sync-external-removed.md`
...
- Manifest 章节：`## 2-1/task-31`
- 依赖任务：`2-1/task-30, 1-4/task-20`
- 风险等级：`High`
- 绑定 UX 页面：`S1-11-main-repo-error`
- 绑定 Core 能力：`C1-19`
- Control map 期望 Core 能力：`S1-11: C1-01, C1-19, C1-21`
- 当前 task 覆盖 Core 能力：`C1-19`
- Secondary capability 状态：`C1-01, C1-21（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-31-s1-11-c1-19-sync-external-removed.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-31`
