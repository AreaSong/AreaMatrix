# Verify-ready Prompt: 2-3/task-35
...
- Phase：`phase-2`
- Task 标识：`2-3/task-35`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-35-s1-35-c1-10-resolve-name-conflict.md`
...
- Manifest 章节：`## 2-3/task-35`
- 依赖任务：`2-3/task-34, 1-2/task-29`
- 风险等级：`High`
- 绑定 UX 页面：`S1-35-change-category-sheet`
- 绑定 Core 能力：`C1-10`
- Control map 期望 Core 能力：`S1-35: C1-24, C1-10`
- 当前 task 覆盖 Core 能力：`C1-10`
- Secondary capability 状态：`C1-24（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-35-s1-35-c1-10-resolve-name-conflict.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-35`
