# Verify-ready Prompt: 2-4/task-02
...
- Phase：`phase-2`
- Task 标识：`2-4/task-02`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-4-sync-overview/task-02-s1-25-c1-21-error-mapping.md`
...
- Manifest 章节：`## 2-4/task-02`
- 依赖任务：`2-4/task-01, 1-4/task-30`
- 风险等级：`High`
- 绑定 UX 页面：`S1-25-icloud-conflict-min`
- 绑定 Core 能力：`C1-21`
- Control map 期望 Core 能力：`S1-25: C1-01, C1-21`
- 当前 task 覆盖 Core 能力：`C1-21`
- Secondary capability 状态：`C1-01（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-4-sync-overview/task-02-s1-25-c1-21-error-mapping.md`
...
9. 在 manifest 中定位章节：`## 2-4/task-02`
