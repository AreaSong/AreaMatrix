# Verify-ready Prompt: 2-1/task-14
...
- Phase：`phase-2`
- Task 标识：`2-1/task-14`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-14-s1-06-c1-21-error-mapping.md`
...
- Manifest 章节：`## 2-1/task-14`
- 依赖任务：`2-1/task-13, 1-4/task-30`
- 风险等级：`High`
- 绑定 UX 页面：`S1-06-init-failed`
- 绑定 Core 能力：`C1-21`
- Control map 期望 Core 能力：`S1-06: C1-21`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-14-s1-06-c1-21-error-mapping.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-14`
