# Verify-ready Prompt: 2-3/task-29
...
- Phase：`phase-2`
- Task 标识：`2-3/task-29`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-29-s1-32-c1-21-error-mapping.md`
...
- Manifest 章节：`## 2-3/task-29`
- 依赖任务：`2-3/task-28, 1-4/task-30`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-29-s1-32-c1-21-error-mapping.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-29`
