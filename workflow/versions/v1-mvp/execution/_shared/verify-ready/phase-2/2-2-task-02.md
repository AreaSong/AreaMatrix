# Verify-ready Prompt: 2-2/task-02
...
- Phase：`phase-2`
- Task 标识：`2-2/task-02`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-02-s1-17-c1-05-classify-preview.md`
...
- Manifest 章节：`## 2-2/task-02`
- 依赖任务：`2-2/task-01, 1-2/task-04`
- 风险等级：`High`
- 绑定 UX 页面：`S1-17-import-single-sheet`
- 绑定 Core 能力：`C1-05`
- Control map 期望 Core 能力：`S1-17: C1-05, C1-06, C1-07, C1-08`
- 当前 task 覆盖 Core 能力：`C1-05`
- Secondary capability 状态：`C1-06, C1-07, C1-08（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-02-s1-17-c1-05-classify-preview.md`
...
9. 在 manifest 中定位章节：`## 2-2/task-02`
