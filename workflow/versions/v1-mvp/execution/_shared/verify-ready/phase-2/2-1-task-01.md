# Verify-ready Prompt: 2-1/task-01
...
- Phase：`phase-2`
- Task 标识：`2-1/task-01`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-01-s1-01-c1-04-load-update-config.md`
...
- Manifest 章节：`## 2-1/task-01`
- 依赖任务：`1-1/task-19`
- 风险等级：`High`
- 绑定 UX 页面：`S1-01-welcome`
- 绑定 Core 能力：`C1-04`
- Control map 期望 Core 能力：`S1-01: C1-04`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-01-s1-01-c1-04-load-update-config.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-01`
