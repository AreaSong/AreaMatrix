# Verify-ready Prompt: 2-3/task-07
...
- Phase：`phase-2`
- Task 标识：`2-3/task-07`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-07-s1-14-c1-14-read-write-note.md`
...
- Manifest 章节：`## 2-3/task-07`
- 依赖任务：`2-3/task-06, 1-3/task-17`
- 风险等级：`High`
- 绑定 UX 页面：`S1-14-detail-note`
- 绑定 Core 能力：`C1-14`
- Control map 期望 Core 能力：`S1-14: C1-14`
- 当前 task 覆盖 Core 能力：`C1-14`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-07-s1-14-c1-14-read-write-note.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-07`
