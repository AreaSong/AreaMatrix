# Verify-ready Prompt: 2-4/task-01
...
- Phase：`phase-2`
- Task 标识：`2-4/task-01`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-4-sync-overview/task-01-s1-25-c1-01-validate-repo-path.md`
...
- Manifest 章节：`## 2-4/task-01`
- 依赖任务：`2-3/task-37, 1-1/task-04`
- 风险等级：`High`
- 绑定 UX 页面：`S1-25-icloud-conflict-min`
- 绑定 Core 能力：`C1-01`
- Control map 期望 Core 能力：`S1-25: C1-01, C1-21`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-4-sync-overview/task-01-s1-25-c1-01-validate-repo-path.md`
...
9. 在 manifest 中定位章节：`## 2-4/task-01`
