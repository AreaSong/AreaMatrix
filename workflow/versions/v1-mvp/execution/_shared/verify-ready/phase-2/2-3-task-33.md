# Verify-ready Prompt: 2-3/task-33
...
- Phase：`phase-2`
- Task 标识：`2-3/task-33`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-33-s1-34-c1-23-delete-remove-index.md`
...
- Manifest 章节：`## 2-3/task-33`
- 依赖任务：`2-3/task-32, 1-5/task-10`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-33-s1-34-c1-23-delete-remove-index.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-33`
