# Verify-ready Prompt: 2-1/task-17
...
- Phase：`phase-2`
- Task 标识：`2-1/task-17`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-17-s1-07-page-integration-verify.md`
...
- Manifest 章节：`## 2-1/task-17`
- 依赖任务：`2-1/task-15, 2-1/task-16`
- 风险等级：`High`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-17-s1-07-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-17`
