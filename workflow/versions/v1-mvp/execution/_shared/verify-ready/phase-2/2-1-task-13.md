# Verify-ready Prompt: 2-1/task-13
...
- Phase：`phase-2`
- Task 标识：`2-1/task-13`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-13-s1-05-page-integration-verify.md`
...
- Manifest 章节：`## 2-1/task-13`
- 依赖任务：`2-1/task-10, 2-1/task-11, 2-1/task-12`
- 风险等级：`High`
- 绑定 UX 页面：`S1-05-initializing`
- 绑定 Core 能力：`C1-02, C1-03, C1-16`
- Control map 期望 Core 能力：`S1-05: C1-02, C1-03, C1-16`
- 当前 task 覆盖 Core 能力：`C1-02, C1-03, C1-16`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-13-s1-05-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-13`
