# Verify-ready Prompt: 2-2/task-06
...
- Phase：`phase-2`
- Task 标识：`2-2/task-06`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-06-s1-17-page-integration-verify.md`
...
- Manifest 章节：`## 2-2/task-06`
- 依赖任务：`2-2/task-02, 2-2/task-03, 2-2/task-04, 2-2/task-05`
- 风险等级：`High`
- 绑定 UX 页面：`S1-17-import-single-sheet`
- 绑定 Core 能力：`C1-05, C1-06, C1-07, C1-08`
- Control map 期望 Core 能力：`S1-17: C1-05, C1-06, C1-07, C1-08`
- 当前 task 覆盖 Core 能力：`C1-05, C1-06, C1-07, C1-08`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-06-s1-17-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-2/task-06`
