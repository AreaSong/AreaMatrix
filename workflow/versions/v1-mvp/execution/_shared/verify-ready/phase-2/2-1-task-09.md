# Verify-ready Prompt: 2-1/task-09
...
- Phase：`phase-2`
- Task 标识：`2-1/task-09`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-09-s1-04-page-integration-verify.md`
...
- Manifest 章节：`## 2-1/task-09`
- 依赖任务：`2-1/task-07, 2-1/task-08`
- 风险等级：`High`
- 绑定 UX 页面：`S1-04-confirm-init`
- 绑定 Core 能力：`C1-02, C1-03`
- Control map 期望 Core 能力：`S1-04: C1-02, C1-03`
- 当前 task 覆盖 Core 能力：`C1-02, C1-03`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-09-s1-04-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-09`
