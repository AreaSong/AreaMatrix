# Verify-ready Prompt: 2-3/task-30
...
- Phase：`phase-2`
- Task 标识：`2-3/task-30`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-30-s1-32-page-integration-verify.md`
...
- Manifest 章节：`## 2-3/task-30`
- 依赖任务：`2-3/task-28, 2-3/task-29`
- 风险等级：`High`
- 绑定 UX 页面：`S1-32-error-recovery`
- 绑定 Core 能力：`C1-16, C1-21`
- Control map 期望 Core 能力：`S1-32: C1-16, C1-21`
- 当前 task 覆盖 Core 能力：`C1-16, C1-21`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-30-s1-32-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-30`
