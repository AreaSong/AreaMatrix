# Verify-ready Prompt: 2-3/task-18
...
- Phase：`phase-2`
- Task 标识：`2-3/task-18`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-18-s1-27-page-integration-verify.md`
...
- Manifest 章节：`## 2-3/task-18`
- 依赖任务：`2-3/task-15, 2-3/task-16, 2-3/task-17`
- 风险等级：`High`
- 绑定 UX 页面：`S1-27-settings-repository`
- 绑定 Core 能力：`C1-04, C1-08, C1-20`
- Control map 期望 Core 能力：`S1-27: C1-04, C1-08, C1-20`
- 当前 task 覆盖 Core 能力：`C1-04, C1-08, C1-20`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-18-s1-27-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-18`
