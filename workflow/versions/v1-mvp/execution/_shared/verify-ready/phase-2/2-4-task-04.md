# Verify-ready Prompt: 2-4/task-04
...
- Phase：`phase-2`
- Task 标识：`2-4/task-04`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-4-sync-overview/task-04-s1-36-c1-25-list-icloud-conflicts.md`
...
- Manifest 章节：`## 2-4/task-04`
- 依赖任务：`2-4/task-03, 1-5/task-20`
- 风险等级：`High`
- 绑定 UX 页面：`S1-36-icloud-conflict-list`
- 绑定 Core 能力：`C1-25`
- Control map 期望 Core 能力：`S1-36: C1-25`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-4-sync-overview/task-04-s1-36-c1-25-list-icloud-conflicts.md`
...
9. 在 manifest 中定位章节：`## 2-4/task-04`
