# Verify-ready Prompt: 2-2/task-22
...
- Phase：`phase-2`
- Task 标识：`2-2/task-22`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-22-s1-22-c1-09-detect-duplicate.md`
...
- Manifest 章节：`## 2-2/task-22`
- 依赖任务：`2-2/task-21, 1-2/task-24`
- 风险等级：`High`
- 绑定 UX 页面：`S1-22-conflict-duplicate`
- 绑定 Core 能力：`C1-09`
- Control map 期望 Core 能力：`S1-22: C1-09`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-22-s1-22-c1-09-detect-duplicate.md`
...
9. 在 manifest 中定位章节：`## 2-2/task-22`
