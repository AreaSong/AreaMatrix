# Verify-ready Prompt: 2-3/task-11
...
- Phase：`phase-2`
- Task 标识：`2-3/task-11`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-11-detail-integration-verify.md`
...
- Manifest 章节：`## 2-3/task-11`
- 依赖任务：`2-3/task-10`
- 风险等级：`High`
- 绑定 UX 页面：`S1-12-detail-meta, S1-13-detail-log, S1-14-detail-note, S1-15-detail-multi`
- 绑定 Core 能力：`C1-12, C1-13, C1-17, C1-18, C1-19, C1-14, C1-11`
- Control map 期望 Core 能力：`S1-12: C1-12; S1-13: C1-13, C1-17, C1-18, C1-19; S1-14: C1-14; S1-15: C1-11, C1-12`
- 当前 task 覆盖 Core 能力：`C1-11, C1-12, C1-13, C1-14, C1-17, C1-18, C1-19`
- Secondary capability 状态：`None`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `13` 个，现有代码 `2` 项，预期新增路径 `3` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-11-detail-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-11`
