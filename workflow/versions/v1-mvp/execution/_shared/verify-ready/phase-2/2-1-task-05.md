# Verify-ready Prompt: 2-1/task-05
...
- Phase：`phase-2`
- Task 标识：`2-1/task-05`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-05-s1-03-c1-21-error-mapping.md`
...
- Manifest 章节：`## 2-1/task-05`
- 依赖任务：`2-1/task-04, 1-4/task-30`
- 风险等级：`High`
- 绑定 UX 页面：`S1-03-validate-path`
- 绑定 Core 能力：`C1-21`
- Control map 期望 Core 能力：`S1-03: C1-01, C1-03, C1-21`
- 当前 task 覆盖 Core 能力：`C1-21`
- Secondary capability 状态：`C1-01, C1-03（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-05-s1-03-c1-21-error-mapping.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-05`
