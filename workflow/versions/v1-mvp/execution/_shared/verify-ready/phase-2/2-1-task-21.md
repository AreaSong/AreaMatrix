# Verify-ready Prompt: 2-1/task-21
...
- Phase：`phase-2`
- Task 标识：`2-1/task-21`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-21-s1-08-page-integration-verify.md`
...
- Manifest 章节：`## 2-1/task-21`
- 依赖任务：`2-1/task-19, 2-1/task-20`
- 风险等级：`High`
- 绑定 UX 页面：`S1-08-main-empty`
- 绑定 Core 能力：`C1-11, C1-15`
- Control map 期望 Core 能力：`S1-08: C1-11, C1-15`
- 当前 task 覆盖 Core 能力：`C1-11, C1-15`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-1-first-launch-main/task-21-s1-08-page-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 2-1/task-21`
