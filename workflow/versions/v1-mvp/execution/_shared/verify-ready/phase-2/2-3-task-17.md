# Verify-ready Prompt: 2-3/task-17
...
- Phase：`phase-2`
- Task 标识：`2-3/task-17`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-17-s1-27-c1-20-overview-generated.md`
...
- Manifest 章节：`## 2-3/task-17`
- 依赖任务：`2-3/task-16, 1-4/task-25`
- 风险等级：`High`
- 绑定 UX 页面：`S1-27-settings-repository`
- 绑定 Core 能力：`C1-20`
- Control map 期望 Core 能力：`S1-27: C1-04, C1-08, C1-20`
- 当前 task 覆盖 Core 能力：`C1-20`
- Secondary capability 状态：`C1-04, C1-08（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-17-s1-27-c1-20-overview-generated.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-17`
