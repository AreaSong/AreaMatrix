# Verify-ready Prompt: 2-2/task-01
...
- Phase：`phase-2`
- Task 标识：`2-2/task-01`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-01-s1-16-c1-05-classify-preview.md`
...
- Manifest 章节：`## 2-2/task-01`
- 依赖任务：`2-1/task-34, 1-2/task-04`
- 风险等级：`High`
- 绑定 UX 页面：`S1-16-drag-hover`
- 绑定 Core 能力：`C1-05`
- Control map 期望 Core 能力：`S1-16: C1-05`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-01-s1-16-c1-05-classify-preview.md`
...
9. 在 manifest 中定位章节：`## 2-2/task-01`
