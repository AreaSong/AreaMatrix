# Verify-ready Prompt: 2-2/task-23
...
- Phase：`phase-2`
- Task 标识：`2-2/task-23`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-23-s1-23-c1-10-resolve-name-conflict.md`
...
- Manifest 章节：`## 2-2/task-23`
- 依赖任务：`2-2/task-22, 1-2/task-29`
- 风险等级：`High`
- 绑定 UX 页面：`S1-23-conflict-name`
- 绑定 Core 能力：`C1-10`
- Control map 期望 Core 能力：`S1-23: C1-10`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-2-import-conflict/task-23-s1-23-c1-10-resolve-name-conflict.md`
...
9. 在 manifest 中定位章节：`## 2-2/task-23`
