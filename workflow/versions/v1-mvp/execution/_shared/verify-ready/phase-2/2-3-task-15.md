# Verify-ready Prompt: 2-3/task-15
...
- Phase：`phase-2`
- Task 标识：`2-3/task-15`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-15-s1-27-c1-04-load-update-config.md`
...
- Manifest 章节：`## 2-3/task-15`
- 依赖任务：`2-3/task-14, 1-1/task-19`
- 风险等级：`High`
- 绑定 UX 页面：`S1-27-settings-repository`
- 绑定 Core 能力：`C1-04`
- Control map 期望 Core 能力：`S1-27: C1-04, C1-08, C1-20`
- 当前 task 覆盖 Core 能力：`C1-04`
- Secondary capability 状态：`C1-08, C1-20（page-feature task：同页其他能力由其他 task 与 page integration verify 覆盖）`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-2/2-3-detail-settings/task-15-s1-27-c1-04-load-update-config.md`
...
9. 在 manifest 中定位章节：`## 2-3/task-15`
