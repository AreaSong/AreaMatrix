# Verify-ready Prompt: 0-2/task-10
...
- Phase：`phase-0`
- Task 标识：`0-2/task-10`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-0/0-2-engineering-foundation/task-10-macos-app-entry.md`
...
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `2` 个，现有代码 `1` 项，预期新增路径 `2` 项，禁止触碰路径 `1` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-0/0-2-engineering-foundation/task-10-macos-app-entry.md`
...
9. 在 manifest 中定位章节：`## 0-2/task-10`
