# Verify-ready Prompt: 0-2/task-05
...
- Phase：`phase-0`
- Task 标识：`0-2/task-05`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-0/0-2-engineering-foundation/task-05-core-smoke-tests.md`
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-0/0-2-engineering-foundation/task-05-core-smoke-tests.md`
...
9. 在 manifest 中定位章节：`## 0-2/task-05`
