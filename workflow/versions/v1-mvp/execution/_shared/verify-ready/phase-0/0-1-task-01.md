# Verify-ready Prompt: 0-1/task-01
...
- Phase：`phase-0`
- Task 标识：`0-1/task-01`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-0/0-1-执行体系/task-01-治理入口.md`
...
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `4` 个，现有代码 `0` 项，预期新增路径 `8` 项，禁止触碰路径 `5` 项，验证命令 `1` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-0/0-1-执行体系/task-01-治理入口.md`
...
9. 在 manifest 中定位章节：`## 0-1/task-01`
