# Verify-ready Prompt: 0-1/task-02
...
- Phase：`phase-0`
- Task 标识：`0-1/task-02`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-0/0-1-执行体系/task-02-prompt-runner.md`
...
- Phase Manifest：`./workflow/versions/v1-mvp/execution/_shared/manifests/phase-0.md`
- Manifest 章节：`## 0-1/task-02`
- 依赖任务：`0-1/task-01`
- 风险等级：`Medium`
- 绑定 UX 页面：`None`
- 绑定 Core 能力：`None`
- Control map 期望 Core 能力：`None`
- 当前 task 覆盖 Core 能力：`None`
- Secondary capability 状态：`None`
- Control map 之外能力：`None`
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `4` 个，现有代码 `0` 项，预期新增路径 `12` 项，禁止触碰路径 `2` 项，验证命令 `4` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-0/0-1-执行体系/task-02-prompt-runner.md`
...
8. 读取 phase manifest：`./workflow/versions/v1-mvp/execution/_shared/manifests/phase-0.md`
9. 在 manifest 中定位章节：`## 0-1/task-02`
