# Verify-ready Prompt: 0-2/task-13
...
- 类型：单任务验收
- 任务类型：`integration`
- 任务细分：`foundation-verify`
- Phase：`phase-0`
- Task 标识：`0-2/task-13`
- Task 文件：`./workflow/versions/v1-mvp/execution/phase-0/0-2-engineering-foundation/task-13-foundation-integration-verify.md`
...
- 是否允许修改文件：`否，本模式只读验收`
- Manifest 计数：文档 `4` 个，现有代码 `3` 项，预期新增路径 `4` 项，禁止触碰路径 `5` 项，验证命令 `2` 个
...
1. 读取 task 文件：`./workflow/versions/v1-mvp/execution/phase-0/0-2-engineering-foundation/task-13-foundation-integration-verify.md`
...
9. 在 manifest 中定位章节：`## 0-2/task-13`
