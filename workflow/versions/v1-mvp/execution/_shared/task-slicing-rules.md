...
1. 绑定的 UX 页面规格：当前已完成 v1 MVP 队列使用 `workflow/versions/v1-mvp/source-docs/ux/page-specs/**/S*.md`；未来版本使用其实际 `workflow/versions/v*/source-docs/`。
2. 绑定的 Core 能力规格：当前已完成 v1 MVP 队列使用 `workflow/versions/v1-mvp/source-docs/core/capability-specs/**/C*.md`；未来版本使用其实际 `workflow/versions/v*/source-docs/`。
3. 对应阶段的 control map：当前已完成 v1 MVP 队列使用 `workflow/versions/v1-mvp/source-docs/architecture/*control-map.md`；未来版本使用其实际 `workflow/versions/v*/source-docs/`。
