...
- 验收 prompt 由 `python3 workflow/versions/v1-mvp/execution/_shared/prompt_pipeline.py verify --task <label>` 生成。
- 阶段验收 prompt 由 `python3 workflow/versions/v1-mvp/execution/_shared/prompt_pipeline.py verify --phase <phase>` 生成。
