...
> Manifest：`workflow/versions/v1-mvp/execution/_shared/manifests/phase-0.md`

## 范围

建立 `workflow/versions/v1-mvp/execution/` 任务库和手动串行 runner，只输出计划与可复制 prompt，不调用 Codex 自动执行。
