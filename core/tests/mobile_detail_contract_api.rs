...
const CAPABILITY_SPEC: &str =
    include_str!("../../workflow/versions/v4/source-docs/core/capability-specs/stage-4-multiplatform/C4-07-mobile-detail.md");
...
const MOBILE_DETAIL_PAGE: &str =
    include_str!("../../workflow/versions/v4/source-docs/ux/page-specs/stage-4-multiplatform/S4-IOS-05-mobile-file-detail.md");
