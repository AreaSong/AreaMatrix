...
const CAPABILITY_SPEC: &str =
    include_str!("../../workflow/versions/v2/source-docs/core/capability-specs/stage-2-experience/C2-06-batch-add-tags.md");
...
const BATCH_ADD_TAGS_PAGE: &str =
    include_str!("../../workflow/versions/v2/source-docs/ux/page-specs/stage-2-experience/S2-09-batch-add-tags.md");
