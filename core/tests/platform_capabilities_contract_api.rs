...
const PLATFORM_DIFFERENCES_PAGE: &str =
    include_str!("../../workflow/versions/v4/source-docs/ux/page-specs/stage-4-multiplatform/S4-X-02-platform-differences.md");
...
const REPOSITORY_SETTINGS_PAGE: &str =
    include_str!("../../workflow/versions/v4/source-docs/ux/page-specs/stage-4-multiplatform/S4-X-08-repository-settings.md");
