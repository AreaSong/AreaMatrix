...
_ACTION_SPECS = (
    ...
    ActionSpec("metrics", command="metrics", group="tool", label_key="action.metrics.label", note_key="action.metrics.note", passthrough=True),
    ...
    ActionSpec("governance", command="governance", group="tool", label_key="action.governance.label", note_key="action.governance.note", passthrough=True),
