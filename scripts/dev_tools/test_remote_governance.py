...
from scripts.dev_tools.remote_governance import remote_governance_audit_result
...
class RemoteGovernanceAuditTest(unittest.TestCase):
    ...
    def test_authenticated_remote_policy_can_pass(self) -> None:
        ...
        api_payloads = [
            ...
            },
            {
                ...
                "required_status_checks": {"contexts": ["governance", "macos"]},
    ...
    def test_missing_required_review_blocks_even_when_actions_pass(self) -> None:
        ...
        api_payloads = [
            ...
            {"url": "https://api.github.com", "required_status_checks": {"contexts": ["governance"]}},
            {"content": codeowners, "encoding": "base64"},
        ]
