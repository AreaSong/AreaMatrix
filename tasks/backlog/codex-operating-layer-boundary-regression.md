...
| Skill owner 污染 | PASS | `.codex/skills-src/README.md`、`.codex/references/index.md`、`./dev check quality` | 现有 8 个 repo-local skills 仍有明确 owner；外部能力需 admission gate，不隐式接入。 |
