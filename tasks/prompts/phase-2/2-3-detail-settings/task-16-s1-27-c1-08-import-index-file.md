# 2-3/task-16: S1-27 + C1-08 import-index-file
...
实现 S1-27 settings-repository 中由 C1-08 import-index-file 支撑的页面功能点。
...
- S1-27 中 C1-08 对应的用户可见功能可被触发和验收。
