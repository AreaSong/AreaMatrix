# 2-3/task-31: settings-error-recovery integration verify
...
验收 settings-error-recovery 闭环中的页面、Core 能力和导航/状态 wiring。

## 绑定

- 集成验收页面：S1-26, S1-27, S1-28, S1-29, S1-30, S1-31, S1-32
- 集成验收能力：C1-04, C1-07, C1-08, C1-20, C1-05, C1-16, C1-21
