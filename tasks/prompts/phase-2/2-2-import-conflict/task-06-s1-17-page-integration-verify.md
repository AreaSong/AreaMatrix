# 2-2/task-06: S1-17 page integration verify
...
验收 S1-17 import-single-sheet 的整页多功能闭环。

## 绑定

- UX 页面：S1-17 import-single-sheet
- 页面能力：C1-05, C1-06, C1-07, C1-08
- 页面功能任务：2-2/task-02, 2-2/task-03, 2-2/task-04, 2-2/task-05
...
- S1-17 页面可以按 page spec 和 control map 完整验收。
