# 2-1/task-06: S1-03 page integration verify
...
验收 S1-03 validate-path 的整页多功能闭环。

## 绑定

- UX 页面：S1-03 validate-path
- 页面能力：C1-01, C1-03, C1-21
- 页面功能任务：2-1/task-03, 2-1/task-04, 2-1/task-05
...
- S1-03 页面可以按 page spec 和 control map 完整验收。
