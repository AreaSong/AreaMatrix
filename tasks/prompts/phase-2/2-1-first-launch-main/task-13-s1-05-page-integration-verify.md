# 2-1/task-13: S1-05 page integration verify
...
验收 S1-05 initializing 的整页多功能闭环。

## 绑定

- UX 页面：S1-05 initializing
- 页面能力：C1-02, C1-03, C1-16
- 页面功能任务：2-1/task-10, 2-1/task-11, 2-1/task-12
...
- S1-05 页面可以按 page spec 和 control map 完整验收。
