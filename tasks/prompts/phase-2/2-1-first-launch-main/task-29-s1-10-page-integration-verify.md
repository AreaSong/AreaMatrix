# 2-1/task-29: S1-10 page integration verify
...
验收 S1-10 main-loading 的整页多功能闭环。

## 绑定

- UX 页面：S1-10 main-loading
- 页面能力：C1-03, C1-15, C1-16
- 页面功能任务：2-1/task-26, 2-1/task-27, 2-1/task-28
...
- S1-10 页面可以按 page spec 和 control map 完整验收。
