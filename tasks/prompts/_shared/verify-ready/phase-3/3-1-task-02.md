...
- Phase：`phase-3`
- Task 标识：`3-1/task-02`
- Task 文件：`./tasks/prompts/phase-3/3-1-stability-release/task-02-recovery-scenarios.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-3/3-1-stability-release/task-02-recovery-scenarios.md`
