...
- Phase：`phase-3`
- Task 标识：`3-1/task-05`
- Task 文件：`./tasks/prompts/phase-3/3-1-stability-release/task-05-stage1-integration-verify.md`
...
- Phase Manifest：`./tasks/prompts/_shared/manifests/phase-3.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-3/3-1-stability-release/task-05-stage1-integration-verify.md`
...
8. 读取 phase manifest：`./tasks/prompts/_shared/manifests/phase-3.md`
