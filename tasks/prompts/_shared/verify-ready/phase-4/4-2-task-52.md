...
- Phase：`phase-4`
- Task 标识：`4-2/task-52`
- Task 文件：`./tasks/prompts/phase-4/4-2-stage3-ai/task-52-s3-02-c3-02-local-model-status.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-4/4-2-stage3-ai/task-52-s3-02-c3-02-local-model-status.md`
