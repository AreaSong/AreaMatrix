...
- Phase：`phase-4`
- Task 标识：`4-1/task-35`
- Task 文件：`./tasks/prompts/phase-4/4-1-stage2-experience/task-35-c2-07-integration-verify.md`
- 共享规则：`./tasks/prompts/_shared/audit-rules.md`
- 任务切片规则：`./tasks/prompts/_shared/task-slicing-rules.md`
- 工程质量规则：`./tasks/prompts/_shared/engineering-quality-rules.md`
...
- 依赖关系：`./tasks/prompts/_shared/dependency-graph.md`
- Phase Manifest：`./tasks/prompts/_shared/manifests/phase-4.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-4/4-1-stage2-experience/task-35-c2-07-integration-verify.md`
2. 读取共享规则：`./tasks/prompts/_shared/audit-rules.md`
3. 读取任务切片规则：`./tasks/prompts/_shared/task-slicing-rules.md`
4. 读取工程质量规则：`./tasks/prompts/_shared/engineering-quality-rules.md`
...
7. 读取依赖关系：`./tasks/prompts/_shared/dependency-graph.md`
8. 读取 phase manifest：`./tasks/prompts/_shared/manifests/phase-4.md`
