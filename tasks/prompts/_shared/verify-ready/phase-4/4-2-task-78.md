...
- Phase：`phase-4`
- Task 标识：`4-2/task-78`
- Task 文件：`./tasks/prompts/phase-4/4-2-stage3-ai/task-78-s3-10-page-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-4/4-2-stage3-ai/task-78-s3-10-page-integration-verify.md`
