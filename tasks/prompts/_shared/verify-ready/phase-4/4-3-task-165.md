...
- Task 文件：`./tasks/prompts/phase-4/4-3-stage4-multiplatform/task-165-stage-4-multiplatform-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-4/4-3-stage4-multiplatform/task-165-stage-4-multiplatform-integration-verify.md`
