...
- Task 文件：`./tasks/prompts/phase-4/4-3-stage4-multiplatform/task-160-s4-x-08-c4-20-repository-settings-cross-platform.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-4/4-3-stage4-multiplatform/task-160-s4-x-08-c4-20-repository-settings-cross-platform.md`
