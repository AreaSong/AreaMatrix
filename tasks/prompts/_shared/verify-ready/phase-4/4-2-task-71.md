...
- Phase：`phase-4`
- Task 标识：`4-2/task-71`
- Task 文件：`./tasks/prompts/phase-4/4-2-stage3-ai/task-71-s3-09-c3-01-ai-settings-config.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-4/4-2-stage3-ai/task-71-s3-09-c3-01-ai-settings-config.md`
