...
- Phase：`phase-4`
- Task 标识：`4-3/task-60`
- Task 文件：`./tasks/prompts/phase-4/4-3-stage4-multiplatform/task-60-c4-12-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-4/4-3-stage4-multiplatform/task-60-c4-12-integration-verify.md`
