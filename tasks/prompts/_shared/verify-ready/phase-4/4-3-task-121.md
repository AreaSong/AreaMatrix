...
- Task 文件：`./tasks/prompts/phase-4/4-3-stage4-multiplatform/task-121-s4-win-03-c4-08-cloud-permission-state.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-4/4-3-stage4-multiplatform/task-121-s4-win-03-c4-08-cloud-permission-state.md`
