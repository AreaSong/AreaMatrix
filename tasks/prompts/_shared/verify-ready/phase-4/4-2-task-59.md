...
- Phase：`phase-4`
- Task 标识：`4-2/task-59`
- Task 文件：`./tasks/prompts/phase-4/4-2-stage3-ai/task-59-s3-04-page-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-4/4-2-stage3-ai/task-59-s3-04-page-integration-verify.md`
