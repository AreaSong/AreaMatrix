...
- Phase：`phase-4`
- Task 标识：`4-1/task-98`
- Task 文件：`./tasks/prompts/phase-4/4-1-stage2-experience/task-98-s2-01-page-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-4/4-1-stage2-experience/task-98-s2-01-page-integration-verify.md`
