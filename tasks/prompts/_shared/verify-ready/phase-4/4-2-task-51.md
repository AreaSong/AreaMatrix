...
- Phase：`phase-4`
- Task 标识：`4-2/task-51`
- Task 文件：`./tasks/prompts/phase-4/4-2-stage3-ai/task-51-s3-01-c3-01-ai-settings-config.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-4/4-2-stage3-ai/task-51-s3-01-c3-01-ai-settings-config.md`
