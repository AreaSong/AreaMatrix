...
- Phase：`phase-4`
- Task 标识：`4-2/task-53`
- Task 文件：`./tasks/prompts/phase-4/4-2-stage3-ai/task-53-s3-03-c3-03-remote-provider-config.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-4/4-2-stage3-ai/task-53-s3-03-c3-03-remote-provider-config.md`
