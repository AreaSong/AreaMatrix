...
- Phase：`phase-2`
- Task 标识：`2-4/task-06`
- Task 文件：`./tasks/prompts/phase-2/2-4-sync-overview/task-06-s1-37-c1-16-recover-on-startup.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-4-sync-overview/task-06-s1-37-c1-16-recover-on-startup.md`
