...
- Phase：`phase-2`
- Task 标识：`2-1/task-18`
- Task 文件：`./tasks/prompts/phase-2/2-1-first-launch-main/task-18-first-launch-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-1-first-launch-main/task-18-first-launch-integration-verify.md`
