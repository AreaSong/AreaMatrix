...
- Phase：`phase-2`
- Task 标识：`2-3/task-21`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-21-s1-28-page-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-21-s1-28-page-integration-verify.md`
