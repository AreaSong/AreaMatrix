...
- Phase：`phase-2`
- Task 标识：`2-3/task-24`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-24-s1-30-c1-16-recover-on-startup.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-24-s1-30-c1-16-recover-on-startup.md`
