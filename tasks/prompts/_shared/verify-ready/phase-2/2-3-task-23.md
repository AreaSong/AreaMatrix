...
- Phase：`phase-2`
- Task 标识：`2-3/task-23`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-23-s1-30-c1-04-load-update-config.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-23-s1-30-c1-04-load-update-config.md`
