...
- Phase：`phase-2`
- Task 标识：`2-4/task-02`
- Task 文件：`./tasks/prompts/phase-2/2-4-sync-overview/task-02-s1-25-c1-21-error-mapping.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-4-sync-overview/task-02-s1-25-c1-21-error-mapping.md`
