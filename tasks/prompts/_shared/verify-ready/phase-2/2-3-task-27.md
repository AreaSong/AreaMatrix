...
- Phase：`phase-2`
- Task 标识：`2-3/task-27`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-27-s1-31-ui-only.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-27-s1-31-ui-only.md`
