...
- Phase：`phase-2`
- Task 标识：`2-4/task-01`
- Task 文件：`./tasks/prompts/phase-2/2-4-sync-overview/task-01-s1-25-c1-01-validate-repo-path.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-4-sync-overview/task-01-s1-25-c1-01-validate-repo-path.md`
