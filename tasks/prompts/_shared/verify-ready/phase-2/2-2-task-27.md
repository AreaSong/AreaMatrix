...
- Phase：`phase-2`
- Task 标识：`2-2/task-27`
- Task 文件：`./tasks/prompts/phase-2/2-2-import-conflict/task-27-import-conflict-integration-verify.md`
...
- Phase Manifest：`./tasks/prompts/_shared/manifests/phase-2.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-2-import-conflict/task-27-import-conflict-integration-verify.md`
...
8. 读取 phase manifest：`./tasks/prompts/_shared/manifests/phase-2.md`
