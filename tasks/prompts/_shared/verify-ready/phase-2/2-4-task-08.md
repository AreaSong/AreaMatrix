...
- Phase：`phase-2`
- Task 标识：`2-4/task-08`
- Task 文件：`./tasks/prompts/phase-2/2-4-sync-overview/task-08-sync-overview-repair-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-4-sync-overview/task-08-sync-overview-repair-integration-verify.md`
