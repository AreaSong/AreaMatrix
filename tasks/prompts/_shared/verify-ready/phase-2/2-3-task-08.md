...
- Phase：`phase-2`
- Task 标识：`2-3/task-08`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-08-s1-15-c1-11-list-files.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-08-s1-15-c1-11-list-files.md`
