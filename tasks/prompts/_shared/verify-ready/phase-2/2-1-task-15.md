...
- Phase：`phase-2`
- Task 标识：`2-1/task-15`
- Task 文件：`./tasks/prompts/phase-2/2-1-first-launch-main/task-15-s1-07-c1-02-init-empty-repo.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-1-first-launch-main/task-15-s1-07-c1-02-init-empty-repo.md`
