...
- Phase：`phase-2`
- Task 标识：`2-3/task-02`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-02-s1-13-c1-13-list-change-log.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-02-s1-13-c1-13-list-change-log.md`
