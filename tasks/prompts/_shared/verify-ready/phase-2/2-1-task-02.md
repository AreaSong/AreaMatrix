...
- Phase：`phase-2`
- Task 标识：`2-1/task-02`
- Task 文件：`./tasks/prompts/phase-2/2-1-first-launch-main/task-02-s1-02-c1-01-validate-repo-path.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-1-first-launch-main/task-02-s1-02-c1-01-validate-repo-path.md`
