...
- Phase：`phase-2`
- Task 标识：`2-3/task-18`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-18-s1-27-page-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-18-s1-27-page-integration-verify.md`
