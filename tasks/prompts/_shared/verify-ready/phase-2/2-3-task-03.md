...
- Phase：`phase-2`
- Task 标识：`2-3/task-03`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-03-s1-13-c1-17-sync-external-created.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-03-s1-13-c1-17-sync-external-created.md`
