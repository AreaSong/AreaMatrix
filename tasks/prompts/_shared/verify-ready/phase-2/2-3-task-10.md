...
- Phase：`phase-2`
- Task 标识：`2-3/task-10`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-10-s1-15-page-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-10-s1-15-page-integration-verify.md`
