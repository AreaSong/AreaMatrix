...
- Phase：`phase-2`
- Task 标识：`2-1/task-01`
- Task 文件：`./tasks/prompts/phase-2/2-1-first-launch-main/task-01-s1-01-c1-04-load-update-config.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-1-first-launch-main/task-01-s1-01-c1-04-load-update-config.md`
