...
- Phase：`phase-2`
- Task 标识：`2-3/task-35`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-35-s1-35-c1-10-resolve-name-conflict.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-35-s1-35-c1-10-resolve-name-conflict.md`
