...
- Phase：`phase-2`
- Task 标识：`2-4/task-07`
- Task 文件：`./tasks/prompts/phase-2/2-4-sync-overview/task-07-s1-37-page-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-4-sync-overview/task-07-s1-37-page-integration-verify.md`
