...
- Phase：`phase-2`
- Task 标识：`2-3/task-12`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-12-s1-26-c1-04-load-update-config.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-12-s1-26-c1-04-load-update-config.md`
