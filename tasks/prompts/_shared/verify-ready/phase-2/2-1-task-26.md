...
- Phase：`phase-2`
- Task 标识：`2-1/task-26`
- Task 文件：`./tasks/prompts/phase-2/2-1-first-launch-main/task-26-s1-10-c1-03-adopt-existing-repo.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-1-first-launch-main/task-26-s1-10-c1-03-adopt-existing-repo.md`
