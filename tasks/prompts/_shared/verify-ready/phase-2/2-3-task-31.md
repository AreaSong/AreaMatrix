...
- Phase：`phase-2`
- Task 标识：`2-3/task-31`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-31-settings-error-recovery-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-31-settings-error-recovery-integration-verify.md`
