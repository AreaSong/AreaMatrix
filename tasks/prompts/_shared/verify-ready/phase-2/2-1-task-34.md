...
- Phase：`phase-2`
- Task 标识：`2-1/task-34`
- Task 文件：`./tasks/prompts/phase-2/2-1-first-launch-main/task-34-main-window-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-1-first-launch-main/task-34-main-window-integration-verify.md`
