...
- Phase：`phase-2`
- Task 标识：`2-3/task-29`
- Task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-29-s1-32-c1-21-error-mapping.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-2/2-3-detail-settings/task-29-s1-32-c1-21-error-mapping.md`
