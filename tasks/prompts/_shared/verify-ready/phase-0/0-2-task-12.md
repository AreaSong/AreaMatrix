...
- Phase：`phase-0`
- Task 标识：`0-2/task-12`
- Task 文件：`./tasks/prompts/phase-0/0-2-engineering-foundation/task-12-macos-test-target.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-0/0-2-engineering-foundation/task-12-macos-test-target.md`
