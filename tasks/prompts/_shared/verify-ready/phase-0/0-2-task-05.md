...
- Phase：`phase-0`
- Task 标识：`0-2/task-05`
- Task 文件：`./tasks/prompts/phase-0/0-2-engineering-foundation/task-05-core-smoke-tests.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-0/0-2-engineering-foundation/task-05-core-smoke-tests.md`
