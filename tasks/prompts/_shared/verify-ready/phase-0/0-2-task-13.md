...
- Phase：`phase-0`
- Task 标识：`0-2/task-13`
- Task 文件：`./tasks/prompts/phase-0/0-2-engineering-foundation/task-13-foundation-integration-verify.md`
...
- Phase Manifest：`./tasks/prompts/_shared/manifests/phase-0.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-0/0-2-engineering-foundation/task-13-foundation-integration-verify.md`
...
8. 读取 phase manifest：`./tasks/prompts/_shared/manifests/phase-0.md`
