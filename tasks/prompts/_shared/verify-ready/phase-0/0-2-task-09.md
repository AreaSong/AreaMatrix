...
- Phase：`phase-0`
- Task 标识：`0-2/task-09`
- Task 文件：`./tasks/prompts/phase-0/0-2-engineering-foundation/task-09-macos-xcode-project.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-0/0-2-engineering-foundation/task-09-macos-xcode-project.md`
