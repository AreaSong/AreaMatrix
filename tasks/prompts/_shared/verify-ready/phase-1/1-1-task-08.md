...
- Phase：`phase-1`
- Task 标识：`1-1/task-08`
- Task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-08-c1-02-validation.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-08-c1-02-validation.md`
