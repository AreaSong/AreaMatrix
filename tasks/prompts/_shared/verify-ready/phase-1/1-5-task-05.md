...
- Phase：`phase-1`
- Task 标识：`1-5/task-05`
- Task 文件：`./tasks/prompts/phase-1/1-5-file-actions-repair/task-05-c1-22-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-5-file-actions-repair/task-05-c1-22-integration-verify.md`
