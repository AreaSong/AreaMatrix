...
- Phase：`phase-1`
- Task 标识：`1-4/task-25`
- Task 文件：`./tasks/prompts/phase-1/1-4-recovery-sync-overview/task-25-c1-20-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-4-recovery-sync-overview/task-25-c1-20-integration-verify.md`
