...
- Phase：`phase-1`
- Task 标识：`1-1/task-12`
- Task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-12-c1-03-failure-recovery.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-12-c1-03-failure-recovery.md`
