...
- Phase：`phase-1`
- Task 标识：`1-1/task-03`
- Task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-03-c1-01-validation.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-03-c1-01-validation.md`
