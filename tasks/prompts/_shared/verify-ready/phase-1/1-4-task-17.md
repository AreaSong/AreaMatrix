...
- Phase：`phase-1`
- Task 标识：`1-4/task-17`
- Task 文件：`./tasks/prompts/phase-1/1-4-recovery-sync-overview/task-17-c1-19-implementation.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-4-recovery-sync-overview/task-17-c1-19-implementation.md`
