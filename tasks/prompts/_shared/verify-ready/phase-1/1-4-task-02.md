...
- Phase：`phase-1`
- Task 标识：`1-4/task-02`
- Task 文件：`./tasks/prompts/phase-1/1-4-recovery-sync-overview/task-02-c1-16-implementation.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-4-recovery-sync-overview/task-02-c1-16-implementation.md`
