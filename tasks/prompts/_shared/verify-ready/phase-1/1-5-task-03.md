...
- Phase：`phase-1`
- Task 标识：`1-5/task-03`
- Task 文件：`./tasks/prompts/phase-1/1-5-file-actions-repair/task-03-c1-22-failure-recovery.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-5-file-actions-repair/task-03-c1-22-failure-recovery.md`
