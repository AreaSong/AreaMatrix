...
- Phase：`phase-1`
- Task 标识：`1-3/task-07`
- Task 文件：`./tasks/prompts/phase-1/1-3-query-detail/task-07-c1-12-validation.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-3-query-detail/task-07-c1-12-validation.md`
