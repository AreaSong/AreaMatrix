...
- Phase：`phase-1`
- Task 标识：`1-4/task-26`
- Task 文件：`./tasks/prompts/phase-1/1-4-recovery-sync-overview/task-26-c1-21-contract-api.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-4-recovery-sync-overview/task-26-c1-21-contract-api.md`
