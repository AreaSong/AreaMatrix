...
- Phase：`phase-1`
- Task 标识：`1-1/task-04`
- Task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-04-c1-01-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-04-c1-01-integration-verify.md`
