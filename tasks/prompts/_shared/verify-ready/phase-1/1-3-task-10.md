...
- Phase：`phase-1`
- Task 标识：`1-3/task-10`
- Task 文件：`./tasks/prompts/phase-1/1-3-query-detail/task-10-c1-13-implementation.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-3-query-detail/task-10-c1-13-implementation.md`
