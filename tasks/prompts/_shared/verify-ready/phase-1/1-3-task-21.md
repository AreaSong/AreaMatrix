...
- Phase：`phase-1`
- Task 标识：`1-3/task-21`
- Task 文件：`./tasks/prompts/phase-1/1-3-query-detail/task-21-c1-15-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-3-query-detail/task-21-c1-15-integration-verify.md`
