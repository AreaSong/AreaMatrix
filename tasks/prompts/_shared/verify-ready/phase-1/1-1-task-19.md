...
- Phase：`phase-1`
- Task 标识：`1-1/task-19`
- Task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-19-c1-04-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-19-c1-04-integration-verify.md`
