...
- Phase：`phase-1`
- Task 标识：`1-1/task-15`
- Task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-15-c1-04-contract-api.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-15-c1-04-contract-api.md`
