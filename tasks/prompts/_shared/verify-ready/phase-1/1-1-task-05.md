...
- Phase：`phase-1`
- Task 标识：`1-1/task-05`
- Task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-05-c1-02-contract-api.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-05-c1-02-contract-api.md`
