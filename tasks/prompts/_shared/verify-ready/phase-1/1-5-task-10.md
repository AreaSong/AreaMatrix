...
- Phase：`phase-1`
- Task 标识：`1-5/task-10`
- Task 文件：`./tasks/prompts/phase-1/1-5-file-actions-repair/task-10-c1-23-integration-verify.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-5-file-actions-repair/task-10-c1-23-integration-verify.md`
