...
- Phase：`phase-1`
- Task 标识：`1-4/task-23`
- Task 文件：`./tasks/prompts/phase-1/1-4-recovery-sync-overview/task-23-c1-20-failure-recovery.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-4-recovery-sync-overview/task-23-c1-20-failure-recovery.md`
