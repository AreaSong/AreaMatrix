...
- Phase：`phase-1`
- Task 标识：`1-3/task-13`
- Task 文件：`./tasks/prompts/phase-1/1-3-query-detail/task-13-c1-14-contract-api.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-3-query-detail/task-13-c1-14-contract-api.md`
