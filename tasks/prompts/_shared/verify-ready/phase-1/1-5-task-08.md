...
- Phase：`phase-1`
- Task 标识：`1-5/task-08`
- Task 文件：`./tasks/prompts/phase-1/1-5-file-actions-repair/task-08-c1-23-failure-recovery.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-5-file-actions-repair/task-08-c1-23-failure-recovery.md`
