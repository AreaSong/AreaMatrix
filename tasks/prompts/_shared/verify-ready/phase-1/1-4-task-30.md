...
- Phase：`phase-1`
- Task 标识：`1-4/task-30`
- Task 文件：`./tasks/prompts/phase-1/1-4-recovery-sync-overview/task-30-c1-21-integration-verify.md`
...
- Phase Manifest：`./tasks/prompts/_shared/manifests/phase-1.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-4-recovery-sync-overview/task-30-c1-21-integration-verify.md`
...
8. 读取 phase manifest：`./tasks/prompts/_shared/manifests/phase-1.md`
