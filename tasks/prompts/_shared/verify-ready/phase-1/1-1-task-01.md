...
- Phase：`phase-1`
- Task 标识：`1-1/task-01`
- Task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-01-c1-01-contract-api.md`
...
1. 读取 task 文件：`./tasks/prompts/phase-1/1-1-repo-config/task-01-c1-01-contract-api.md`
