# 1-3/task-08: C1-12 get-file-detail integration-verify
...
围绕 C1-12 get-file-detail 完成 integration-verify。
...
1. 只处理 C1-12 的 integration-verify 范围。
...
- C1-12 的 integration-verify 目标可用证据证明。
- 没有扩展到未绑定能力。
