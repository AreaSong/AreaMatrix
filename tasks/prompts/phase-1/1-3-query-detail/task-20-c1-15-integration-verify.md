# 1-3/task-20: C1-15 build-tree integration-verify
...
围绕 C1-15 build-tree 完成 integration-verify。
...
1. 只处理 C1-15 的 integration-verify 范围。
...
- C1-15 的 integration-verify 目标可用证据证明。
- 没有扩展到未绑定能力。
