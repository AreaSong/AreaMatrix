# 1-4/task-10: C1-17 sync-external-created integration-verify
...
围绕 C1-17 sync-external-created 完成 integration-verify。
...
1. 只处理 C1-17 的 integration-verify 范围。
...
- C1-17 的 integration-verify 目标可用证据证明。
- 没有扩展到未绑定能力。
