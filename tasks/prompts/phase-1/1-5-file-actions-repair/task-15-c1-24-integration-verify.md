# 1-5/task-15: C1-24 move-to-category integration-verify
...
围绕 C1-24 move-to-category 完成 integration-verify。
...
1. 只处理 C1-24 的 integration-verify 范围。
...
- C1-24 的 integration-verify 目标可用证据证明。
- 没有扩展到未绑定能力。
