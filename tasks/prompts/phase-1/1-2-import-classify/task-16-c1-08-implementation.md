# 1-2/task-16: C1-08 import-index-file implementation
...
围绕 C1-08 import-index-file 完成 implementation。
...
1. 只处理 C1-08 的 implementation 范围。
...
- C1-08 的 implementation 目标可用证据证明。
- 没有扩展到未绑定能力。
