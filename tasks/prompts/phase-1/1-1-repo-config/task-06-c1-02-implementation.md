# 1-1/task-06: C1-02 init-empty-repo implementation
...
围绕 C1-02 init-empty-repo 完成 implementation。
...
1. 只处理 C1-02 的 implementation 范围。
...
- C1-02 的 implementation 目标可用证据证明。
- 没有扩展到未绑定能力。
