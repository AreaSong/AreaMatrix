# 4-1/task-16: C2-04 contract-api
...
为 C2-04 smart-lists 对齐 Core API / UDL 合同，不实现业务逻辑。
...
1. 读取 C2-04 能力规格、Stage 2 Experience control map、Core API 和错误码。
...
- C2-04 的 Core API 合同可被后续 implementation task 直接实现。
