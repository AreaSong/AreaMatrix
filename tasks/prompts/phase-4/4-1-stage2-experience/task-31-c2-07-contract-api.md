# 4-1/task-31: C2-07 contract-api
...
为 C2-07 undo-action-log 对齐 Core API / UDL 合同，不实现业务逻辑。
...
1. 读取 C2-07 能力规格、Stage 2 Experience control map、Core API 和错误码。
...
- C2-07 的 Core API 合同可被后续 implementation task 直接实现。
