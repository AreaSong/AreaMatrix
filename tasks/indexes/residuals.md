...
| `global-product-ui-localization` | `closed` | 独立 Language 页、摘要跳转、四组合 UI fixture、完整 macOS 门禁与双语言 7-target 概述重生成证据均已通过；不是 active task。 | [ADR-0008](../../docs/adr/0008-naming-and-i18n.md) |
