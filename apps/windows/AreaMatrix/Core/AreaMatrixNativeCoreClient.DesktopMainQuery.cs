...
public sealed partial class AreaMatrixNativeCoreClient
{
    ...
    private static WindowsRepositoryCoreException BindingConfigError(string message)
    {
        return new WindowsRepositoryCoreException(WindowsRepositoryErrorKind.Config, message);
    }

    private static WindowsRepositoryCoreException UnsupportedQueryValue(string label, string value)
    {
