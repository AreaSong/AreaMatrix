    ...
    string SuggestedAction)
{
    ...
    private static MissingFileRecoveryError FromWindowsCore(WindowsRepositoryCoreException exception)
    {
        MissingFileRecoveryErrorKind kind = exception.Kind switch
        {
            WindowsRepositoryErrorKind.Db => MissingFileRecoveryErrorKind.Db,
            WindowsRepositoryErrorKind.FileNotFound => MissingFileRecoveryErrorKind.FileNotFound,
            WindowsRepositoryErrorKind.PermissionDenied => MissingFileRecoveryErrorKind.PermissionDenied,
            WindowsRepositoryErrorKind.Config => MissingFileRecoveryErrorKind.Config,
