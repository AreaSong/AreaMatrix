...
{
    private readonly IAreaMatrixSyncConflictDetectCoreClient coreClient;

    public SyncConflictEntryCoreBridge(IAreaMatrixSyncConflictDetectCoreClient coreClient)
    {
