...
public interface IAreaMatrixLinuxMissingFileRecoveryCoreClient
{
...
{
    private readonly IAreaMatrixLinuxMissingFileRecoveryCoreClient coreClient;

    public MissingFileRecoveryCoreBridge(IAreaMatrixLinuxMissingFileRecoveryCoreClient coreClient)
    {
