...
public interface IAreaMatrixLinuxSyncConflictResolveCoreClient
{
...
public interface IAreaMatrixLinuxSyncConflictCoreClient :
    IAreaMatrixLinuxSyncConflictDetectCoreClient,
    IAreaMatrixLinuxSyncConflictResolveCoreClient
{
}

public sealed class SyncConflictEntryCoreBridge : ISyncConflictEntryCoreBridge
{
    private readonly IAreaMatrixLinuxSyncConflictDetectCoreClient detectClient;
    private readonly IAreaMatrixLinuxSyncConflictResolveCoreClient resolveClient;

    public SyncConflictEntryCoreBridge(
        IAreaMatrixLinuxSyncConflictDetectCoreClient detectClient,
        IAreaMatrixLinuxSyncConflictResolveCoreClient resolveClient)
    {
        this.detectClient = detectClient;
        this.resolveClient = resolveClient;
    }

    public SyncConflictEntryCoreBridge(IAreaMatrixLinuxSyncConflictCoreClient coreClient)
