    ...
    string SuggestedAction)
{
    ...
    private static SyncConflictEntryError FromLinuxCore(LinuxRepositoryCoreException exception)
    {
        SyncConflictEntryErrorKind kind = exception.Kind switch
        {
            LinuxRepositoryErrorKind.Db => SyncConflictEntryErrorKind.Db,
            LinuxRepositoryErrorKind.Conflict => SyncConflictEntryErrorKind.Conflict,
            LinuxRepositoryErrorKind.PermissionDenied => SyncConflictEntryErrorKind.PermissionDenied,
            LinuxRepositoryErrorKind.DiskUnavailable => SyncConflictEntryErrorKind.Io,
            LinuxRepositoryErrorKind.Config => SyncConflictEntryErrorKind.Config,
