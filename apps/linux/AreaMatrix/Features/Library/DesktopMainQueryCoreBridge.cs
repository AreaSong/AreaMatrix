...
public interface IAreaMatrixLinuxDesktopQueryCoreClient
{
...
{
    private readonly IAreaMatrixLinuxDesktopQueryCoreClient coreClient;

    public DesktopMainQueryCoreBridge(IAreaMatrixLinuxDesktopQueryCoreClient coreClient)
    {
...
internal static class DesktopMainQueryCoreMapping
{
    ...
    public static LinuxRepositoryError ToRepositoryError(this DesktopQueryCoreException exception)
    {
        LinuxRepositoryErrorKind kind = exception.Kind switch
        {
            DesktopQueryErrorKind.Db => LinuxRepositoryErrorKind.Db,
            DesktopQueryErrorKind.RepoNotInitialized => LinuxRepositoryErrorKind.RepoNotInitialized,
            DesktopQueryErrorKind.FileNotFound => LinuxRepositoryErrorKind.FileNotFound,
            DesktopQueryErrorKind.InvalidPath => LinuxRepositoryErrorKind.InvalidPath,
            DesktopQueryErrorKind.PermissionDenied => LinuxRepositoryErrorKind.PermissionDenied,
            DesktopQueryErrorKind.Config => LinuxRepositoryErrorKind.Config,
            _ => LinuxRepositoryErrorKind.Unavailable
        };

        return new LinuxRepositoryError(kind, exception.Message, exception.Path);
    }
