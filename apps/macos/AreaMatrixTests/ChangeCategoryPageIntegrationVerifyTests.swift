...
final class ChangeCategoryPageIntegrationVerifyTests: XCTestCase {
    ...
    func testS135PageIntegrationDetailMetaMenuRoutesToChangeCategorySheet() async {
        ...
        let pane = MainRepositoryDetailPane(
            ...
            detailTabRequest: model.detailTabRequest, selectedImportProgressRow: nil,
            repoPath: "/tmp/repo",
            batchTagStore: model.tagStore,
            batchTagErrorMapper: model.errorMapper,
            onRetrySelectedFileDetail: {}, onLoadTags: {}, onRetryTags: {},
            onAddTag: { _ in }, onRemoveTag: { _ in }, onUndoTagChange: {}, onDismissTagUndoToast: {},
