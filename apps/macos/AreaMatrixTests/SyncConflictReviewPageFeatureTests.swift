...
private func makeSyncConflictReviewDetailPane(
    ...
    MainRepositoryDetailPane(
        ...
        detailErrorMapping: model.detailErrorMapping, isDetailLoading: model.isDetailLoading,
        selectedFileDetail: model.selectedFileDetail, noteWriteBlock: model.selectedFileNoteWriteBlock,
        ...
        detailTagEditorState: model.detailTagModel.editorState,
        detailTagSuggestionState: model.detailTagModel.suggestionState,
        missingFileRelinkState: model.missingFileRelinkState,
        tagSuggestionPresentationRequest: model.detailTagModel.presentationRequest,
        detailTagUndoToast: model.detailTagModel.undoToast, detailTabRequest: model.detailTabRequest,
        ...
        onBatchCategoryApplied: { _ in }, onBatchDeleteApplied: { _ in },
        onBatchRenameApplied: { _ in }, onBatchCategoryCreateNewCategory: { _ in },
        onRetrySelectedFileDetail: {}, onRetryExternalSync: {},
        tagActions: .noop,
        onCopyPaths: { _ in },
        onOpenNoteFile: { _ in },
