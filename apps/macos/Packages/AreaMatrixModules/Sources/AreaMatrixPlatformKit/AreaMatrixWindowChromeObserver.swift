...
public struct AreaMatrixWindowChromeObserver: NSViewRepresentable {
    public init() {}
    ...
    public final class Coordinator {
        ...
        func restore(window: NSWindow?) {
            ...
            if let previousTitleVisibility { window.titleVisibility = previousTitleVisibility }
            ...
            if let previousIsOpaque { window.isOpaque = previousIsOpaque }
            if let previousBackgroundColor { window.backgroundColor = previousBackgroundColor }
            if let previousStyleMask { window.styleMask = previousStyleMask }
        }
    }
}
