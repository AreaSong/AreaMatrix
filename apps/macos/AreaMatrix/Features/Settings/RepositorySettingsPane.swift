...
extension RepositorySettingsPane {
    init(
        ...
        self.init(
            ...
            existingRepositoryMetadataReader: featureDependencies.existingRepositoryMetadataReader,
            metadataPresenceChecker: featureDependencies.metadataPresenceChecker,
            finderOpener: featureDependencies.finderOpener,
            pathCopier: featureDependencies.pathCopier,
            generatedOverviewRevealer: featureDependencies.generatedOverviewRevealer,
            ...
            accessibilityAnnouncer: featureDependencies.accessibilityAnnouncer,
