...
struct ConnectRepositoryView: View {
    ...
    private var routeDestination: some View {
        if let route = routeCoordinator.activeRoute {
            ConnectRepositoryRouteDestinationView(
                ...
                onRefreshRepositoryAdopt: refreshRepositoryAdoptConfirmation,
                onAdoptRepository: adoptRepository,
    ...
    private func refreshRepositoryAdoptConfirmation(_ candidate: MobileRepositoryCandidate) {
        Task {
            await model.refreshRepositoryAdoptConfirmation(candidate)
        }
    }

    private func adoptRepository(_ candidate: MobileRepositoryCandidate) {
        Task {
